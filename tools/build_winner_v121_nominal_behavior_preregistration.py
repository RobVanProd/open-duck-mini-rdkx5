#!/usr/bin/env python3
"""Preregister the frozen 16-cell V121 nominal physical gate."""
...
TRAINING = ANALYSIS / "winner_v119_recovered_training_validation.json"
BASE = ANALYSIS / "winner_v110_pitch_guard_behavior_preregistration.json"
OUTPUT = ANALYSIS / "winner_v121_nominal_behavior_preregistration.json"
MARKDOWN = (
    ANALYSIS / "WINNER_V121_NOMINAL_BEHAVIOR_PREREGISTRATION_20260724.md"
)
EXPECTED = {
    "v121_transform_contract": (
...
def main() -> int:
    ...
    hashes = {
        "v121_transform_contract": sha256(TRANSFORM),
        "v119_training_validation": sha256(TRAINING),
    ...
    value = {
        "schema_version": "winner_v121.nominal_behavior_preregistration.v1",
        "status": (
            "PREREGISTERED_WINNER_V121_NOMINAL_BEHAVIOR"
            if not failed
            else "HOLD_WINNER_V121_NOMINAL_BEHAVIOR_PREREGISTRATION"
        ),
    ...
    MARKDOWN.write_text(
        "# Winner-v121 nominal behavior preregistration\n\n"
