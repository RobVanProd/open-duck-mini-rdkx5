                ...
                records.append(
                    {
                        ...
                        "qvel": np.asarray(jax.device_get(state.data.qvel), dtype=float).tolist(),
                        "ctrl": np.asarray(jax.device_get(state.data.ctrl), dtype=float).tolist(),
                        "base_quat_wxyz": quat.astype(float).tolist(),
