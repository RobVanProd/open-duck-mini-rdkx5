...
RUNTIME_REDUCED_RESULT_COMMIT = "264ac40074992c72b295a7cbeb141df59ce3d613"
...
REDUCED_RESULT_SHA256 = "1292772e54f3734f2e48b5b0d75fb0c931949d3b7820598c4a9040a8b765dc5e"
RUNTIME_VERIFIER_SHA256 = "44d185e61cf737c3d8ece664d8e8d10837a3e0087d96faea1dae02348a496a88"
RUNTIME_TEST_SHA256 = "c174785969050eb6006166d6896219ace369695db1d2196a25f315d45faf3874"
RUNTIME_ARTIFACT_MANIFEST_SHA256 = (
    "e8e07170df3c218f2a0a2246a1385ac8bc8983f6735b7b6898ce0db2ce153720"
)
...
def main() -> int:
    ...
    reduced_reporting_checks = {
        ...
        "teacher_forced_observation_gate_exact_zero_only": all(
            row["semantic_gates"].get("teacher_forced_observation_exact_zero")
            is True
            and "teacher_forced_observation_at_most_1e_6"
            not in row["semantic_gates"]
            for row in reduced_cells.values()
        ),
    ...
    result = {
        ...
        "reduced_reporting_note": (
            ...
            "Its teacher-forced observation gate now requires exact zero, the old "
            "at_most_1e_6 key is absent, and all four formal and independent values "
            "are exactly 0.0. The correction changed no formal outcome cell."
        ),
        "authority": {
