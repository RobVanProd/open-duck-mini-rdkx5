#!/usr/bin/env python3
"""Run the preregistered V118 16-cell nominal physical gate on CPU."""
...
PREREG = ANALYSIS / "winner_v118_nominal_behavior_preregistration.json"
RESULT = ANALYSIS / "winner_v118_nominal_behavior_result.json"
MARKDOWN = (
    ANALYSIS / "WINNER_V118_NOMINAL_BEHAVIOR_RESULT_20260724.md"
)
PREREG_SHA256 = (
    "b17ebb8580c62d53888117e4d5cce54f941ed24c4f33ed2c5f7b08abb45e7af6"
)
MATRIX_SHA256 = (
    "3b8d078f253be6108e7c97ccee126cb13361eb06425201158bf5e5f038b0861f"
)
...
def main() -> int:
    ...
    result["schema_version"] = "winner_v118.nominal_behavior_result.v1"
    result["status"] = (
        "PASS_WINNER_V118_NOMINAL_BEHAVIOR_VALID_RESULT"
        if valid
        else "INVALID_WINNER_V118_NOMINAL_BEHAVIOR"
    )
    result["decision"] = {
        "status": (
            "ADVANCE_V118_TO_FULL_FROZEN_MATRIX"
            if valid and persistent
            else "REJECT_V118_NOMINAL_POLICY"
        ),
    ...
    MARKDOWN.write_text(
        "# Winner-v118 nominal behavior result\n\n"
        ...
        "or authorize Gate 5, RDK, robot use, torque, or motion.\n",
        encoding="utf-8",
    )
    print(
        json.dumps(
