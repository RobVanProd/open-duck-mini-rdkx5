...
def build_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "pre_execution_stops": [
            {
                "github_run_id": 29870820100,
                "github_run_attempt": 1,
                "github_run_head_sha": "ec88c60d6e0f6c489f0c378bcfcea02dbace8cca",
                "failed_stage": "Verify frozen Winner v22 package",
                "cause": "synthetic float32 learned-error assertion tolerance was 2e-8 while observed maximum error was 2.45123497e-8",
                ...
                "classified_as_policy_evidence": False,
            },
            {
                "github_run_id": 29870957518,
                "github_run_attempt": 1,
                "github_run_head_sha": "114921f238132a9d8851f8b9c8de0538a88c209b",
                "failed_stage": "Verify frozen Winner v22 package",
                "cause": "companion constant-error assertion retained the platform-sensitive 2e-8 tolerance; fixture replaced with exact binary values",
                "snapshot_recovered": False,
                "simulation_executed": False,
                "optimizer_updates": 0,
                "formal_support_cells": 0,
    ...
    args.markdown.write_text(
        "\n".join(
            [
                ...
                "- Pre-execution stops `29870820100`, `29870957518`: package-test fixtures only; snapshot/simulation/updates `0 / 0 / 0`",
