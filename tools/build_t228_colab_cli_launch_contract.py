#!/usr/bin/env python3
"""Freeze T228's one-session Colab CLI launch contract."""
...
PACKAGE_CONTRACT = (
    ANALYSIS / "t228_command_atom_hosted_package_contract.json"
)
PACKAGE = Path(
    "D:/CodexArtifacts/open-duck-policy/"
    "t228_command_atom_20260730.tar.gz"
)
EXECUTOR = ROOT / "tools/execute_t228_colab_cli.py"
OUTPUT = ANALYSIS / "t228_colab_cli_launch_contract.json"
MARKDOWN = ANALYSIS / "T228_COLAB_CLI_LAUNCH_CONTRACT_20260730.md"
SESSION = "t228-command-atom-20260730"
PACKAGE_SHA256 = (
...
def main() -> int:
    ...
    if subprocess.check_output(
        ...
        raise RuntimeError("T228 launch contract requires clean tree")
    ...
    checks = {
        ...
        "package_contract_green": (
            package["status"]
            == "PASS_T228_COMMAND_ATOM_HOSTED_PACKAGE"
        ...
        "executor_uses_exact_driver_and_mechanism": (
            "colab_t228_command_atom_continuation.py" in text
            and "PASS_T228_HOSTED_FULL_PREFLIGHT" in text
            and "--winner_t227_command_atom_bank" in text
            and "--winner_v127_constrained_cost" in text
            and "--winner_t215b_axis_complete_tilt_cost" in text
            and "t227_hosted_runner_readback_exact" in text
    ...
    commands = [
        ...
        [
            ...
            SESSION,
            str(PACKAGE),
            "/content/t228-command-atom-20260730.tar.gz",
        ],
        [
            "colab",
            "exec",
        ...
        [
            ...
            "--session",
            SESSION,
            "/content/t228_launch_receipt.json",
            "<LOCAL_RECEIPT>",
        ],
        ["colab", "stop", "--session", SESSION],
    ]
    value = {
        "schema_version": "open_duck.t228_colab_cli_launch_contract.v1",
        "status": (
            "PASS_T228_COLAB_CLI_LAUNCH_CONTRACT"
            if not failed
            else "HOLD_T228_COLAB_CLI_LAUNCH_CONTRACT"
        ),
        "checks": checks,
    ...
    MARKDOWN.write_text(
        "# T228 Colab CLI launch contract\n\n"
