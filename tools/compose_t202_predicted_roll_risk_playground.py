#!/usr/bin/env python3
"""Compose T202's default-off playground from the frozen T170 base."""
...
def main() -> int:
    ...
    if output.exists():
        raise FileExistsError(f"refusing to reuse T202 tree: {output}")
    required = (
    ...
    manifest = {
        "schema_version": "open_duck.t202_composed_source.v1",
        "base": {
            "path": str(base),
    ...
    manifest_path = output / "T202_COMPOSED_SOURCE_MANIFEST.json"
