#!/usr/bin/env python3
"""Freeze T194's one-session Colab CLI launch contract."""
...
OUTPUT = ANALYSIS / "t194_colab_cli_launch_contract.json"
MARKDOWN = ANALYSIS / "T194_COLAB_CLI_LAUNCH_CONTRACT_20260730.md"
...
def main() -> int:
    ...
    if subprocess.check_output(
        ...
        raise RuntimeError("T194 launch contract requires clean tree")
    ...
    value = {
        "schema_version": "open_duck.t194_colab_cli_launch_contract.v1",
        "status": (
            "PASS_T194_COLAB_CLI_LAUNCH_CONTRACT"
            if not failed
            else "HOLD_T194_COLAB_CLI_LAUNCH_CONTRACT"
        ),
        "checks": checks,
    ...
    MARKDOWN.write_text(
        "# T194 Colab CLI launch contract\n\n"
