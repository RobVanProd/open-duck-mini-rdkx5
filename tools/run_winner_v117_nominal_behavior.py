#!/usr/bin/env python3
"""Run the preregistered V117 16-cell nominal physical gate on CPU."""
...
PREREG = ANALYSIS / "winner_v117_nominal_behavior_preregistration.json"
RESULT = ANALYSIS / "winner_v117_nominal_behavior_result.json"
MARKDOWN = (
    ANALYSIS / "WINNER_V117_NOMINAL_BEHAVIOR_RESULT_20260724.md"
)
PREREG_SHA256 = (
    "a43fdbd583fb316804dcab2ba51039563e20e88f3af7c05e875d9724672c616a"
)
MATRIX_SHA256 = (
    "cc297c0e07d0e2817be240e03cab1734059cc32582b1706351fad3faa094edef"
)
...
def main() -> int:
    ...
    result["schema_version"] = "winner_v117.nominal_behavior_result.v1"
    result["status"] = (
        "PASS_WINNER_V117_NOMINAL_BEHAVIOR_VALID_RESULT"
        if valid
        else "INVALID_WINNER_V117_NOMINAL_BEHAVIOR"
    )
    result["decision"] = {
        "status": (
            "ADVANCE_V117_TO_FULL_FROZEN_MATRIX"
            if valid and persistent
            else "REJECT_V117_NOMINAL_POLICY"
        ),
    ...
    MARKDOWN.write_text(
        "# Winner-v117 nominal behavior result\n\n"
