#!/usr/bin/env python3
"""Run the preregistered V128 16-cell nominal physical gate on CPU."""
...
PREREG = ANALYSIS / "winner_v128_nominal_behavior_preregistration.json"
RESULT = ANALYSIS / "winner_v128_nominal_behavior_result.json"
MARKDOWN = ANALYSIS / "WINNER_V128_NOMINAL_BEHAVIOR_RESULT_20260724.md"
PREREG_SHA256 = (
    "8576315b5ee2ff18516adbd6c91a98010c9db96f929a261287804417d23bf337"
)
MATRIX_SHA256 = (
    "c8b6e172e7f5f4ecc3b02a82c5c5d306637a30703a3ac64c6741618a68ac7c3a"
)
...
def main() -> int:
    ...
    result["schema_version"] = "winner_v128.nominal_behavior_result.v1"
    result["status"] = (
        "PASS_WINNER_V128_NOMINAL_BEHAVIOR_VALID_RESULT"
        if valid
        else "INVALID_WINNER_V128_NOMINAL_BEHAVIOR"
    )
    result["decision"] = {
        "status": (
            "ADVANCE_V128_TO_FULL_FROZEN_MATRIX"
            if valid and persistent
            else "REJECT_V128_NOMINAL_POLICY"
        ),
    ...
    MARKDOWN.write_text(
        "# Winner V128 nominal behavior result\n\n"
