#!/usr/bin/env python3
"""Compose V119 plus the default-off V122 episode-peak objective."""
...
def main() -> int:
    ...
    if output.exists():
        raise FileExistsError(f"refusing to reuse V122 tree: {output}")
    ...
    manifest = {
        "schema_version": "winner_v122.episode_peak_source.v1",
        "base": {
            "path": str(base),
    ...
    manifest_path = (
        output / "WINNER_V122_COMPOSED_SOURCE_MANIFEST.json"
    )
