#!/usr/bin/env python3
"""Run the preregistered V123 16-cell nominal physical gate on CPU."""
...
PREREG = ANALYSIS / "winner_v123_nominal_behavior_preregistration.json"
RESULT = ANALYSIS / "winner_v123_nominal_behavior_result.json"
MARKDOWN = ANALYSIS / "WINNER_V123_NOMINAL_BEHAVIOR_RESULT_20260724.md"
PREREG_SHA256 = (
    "b470600091b03cd93a67dc28cdbd3b298dd03679bd1716acb541fed9d1b15754"
)
MATRIX_SHA256 = (
    "01dbbff6a5351c27b7ac56e2e043706b51b76ec53420e49ff880c81397bad6c3"
)
...
def main() -> int:
    ...
    result["schema_version"] = "winner_v123.nominal_behavior_result.v1"
    result["status"] = (
        "PASS_WINNER_V123_NOMINAL_BEHAVIOR_VALID_RESULT"
        if valid
        else "INVALID_WINNER_V123_NOMINAL_BEHAVIOR"
    )
    result["decision"] = {
        "status": (
            "ADVANCE_V123_TO_FULL_FROZEN_MATRIX"
            if valid and persistent
            else "REJECT_V123_NOMINAL_POLICY"
        ),
    ...
    MARKDOWN.write_text(
        "# Winner-v123 nominal behavior result\n\n"
