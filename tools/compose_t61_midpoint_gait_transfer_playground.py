#!/usr/bin/env python3
"""Compose the default-off T61 midpoint-transfer playground from T55."""
...
def main() -> int:
    ...
    if output.exists():
        raise FileExistsError(f"refusing to reuse T61 tree: {output}")
    required = (
        ...
        / "playground"
        / "common"
        / "t55_dynamic_single_support_curriculum.py",
    )
    ...
    run(
        [
            ...
            "-m",
            "py_compile",
            "playground/common/t55_dynamic_single_support_curriculum.py",
            "playground/common/t61_midpoint_gait_transfer.py",
    ...
    manifest = {
        "schema_version": "open_duck.t61_composed_source.v1",
        "base": {
            "path": str(base),
    ...
    manifest_path = output / "T61_COMPOSED_SOURCE_MANIFEST.json"
