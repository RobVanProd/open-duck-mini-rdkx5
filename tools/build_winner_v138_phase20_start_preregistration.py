...
OUTPUT = ANALYSIS / "winner_v138_phase20_start_preregistration_v2.json"
MARKDOWN = (
    ANALYSIS / "WINNER_V138_PHASE20_START_PREREGISTRATION_V2_20260725.md"
)
EXPECTED = {
    "runner": (
        "c91a99c36492bad4a10d7ee0cce7d08a940e1f2d83a16267fb422d669a06265e"
    ),
    "auditor": (
...
def main() -> int:
    ...
    checks = {
        ...
        "phase_identity_amendment_green": (
    ...
    payload = {
        "schema_version": "winner_v138.phase20_start_preregistration.v2",
        "supersedes": {
            "artifact": "winner_v138_phase20_start_preregistration.json",
            "reason": (
                "V1's first x=0 cell passed every behavior check but stopped "
                "on a host-float64 phase-vector comparison. V2 uses the "
                "bit-exact frozen evaluator phase-20 vector. Phase selection, "
                "matrix, thresholds, policy, ordering, and stop rule are "
                "unchanged."
            ),
        },
        "status": (
    ...
    MARKDOWN.write_text(
        "# Winner V138 phase-20 start preregistration V2\n\n"
