...
- NPZ: `outputs/analysis/phase2_z0026_corrected_source_live_oracle_iter1_phase_contact_student/candidate_mlp.npz`
- ONNX: `outputs/analysis/phase2_z0026_corrected_source_live_oracle_iter1_phase_contact_student/candidate.onnx`

## Fit Metrics

- MAE: `0.005864`
- p95 abs error: `0.015436`
- max abs error: `0.315143`
- target-rate p95: `1.420891` rad/s
- target-rate max: `2.301115` rad/s
