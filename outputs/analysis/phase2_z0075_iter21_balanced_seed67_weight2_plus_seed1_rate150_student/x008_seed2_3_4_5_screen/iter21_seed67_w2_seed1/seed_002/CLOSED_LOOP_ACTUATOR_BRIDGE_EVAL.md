...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_uqv_t2bc_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_sent_target_velocity_p95_rad_s` | 1.5591 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1803 | 0.2500 |
| `min_base_height_m` | 0.0816 | 0.1200 |
| `min_reward_mean` | 0.4475 | 0.3000 |
| `min_forward_command_tracking_ratio` | -0.4738 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.1179 | NA |
| `max_forward_shortfall_cost_mean` | 7.6020 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 282 | fall_or_nan | 0.1803 | 0.0816 | -0.0379 | -0.4738 | 0.4475 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 89.0071 | 0.0369 | 0.0359 | 21.2766 | 77.3050 | 42 |
| fitted | `right` | 86.8794 | 0.0348 | 0.0310 | 21.2766 | 77.3050 | 42 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0218 | 0.0345 | 0.4583 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0088 | 0.0108 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3965 | 0.9065 | 1.0710 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0912 | 0.2961 | 1.1530 |
...
| fitted | `reward/imitation` | 0.5519 | 3.4111 | 4.3323 |
| fitted | `reward/tracking_ang_vel` | 0.4761 | 3.8794 | 5.9996 |
| fitted | `reward/tracking_lin_vel` | 1.3731 | 2.4806 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -0.4738 | 1.1323 | 1.0667 | 7.6020 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 4 | 3 | 0.7500 | 0.0933 | 0.1149 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3484 | 1.2782 | 0.0863 | 0.1363 | 4 | 0.00 |
| fitted | left_knee | 1.5591 | 1.4955 | 0.1041 | 0.1842 | 4 | 0.00 |
| fitted | left_ankle | 1.4004 | 1.3015 | 0.0897 | 0.1468 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.2903 | 1.2134 | 0.0830 | 0.1234 | 4 | 0.00 |
| fitted | right_knee | 1.5339 | 1.4539 | 0.1015 | 0.1691 | 4 | 0.00 |
| fitted | right_ankle | 1.3421 | 1.3052 | 0.0883 | 0.1437 | 4 | 0.00 |
