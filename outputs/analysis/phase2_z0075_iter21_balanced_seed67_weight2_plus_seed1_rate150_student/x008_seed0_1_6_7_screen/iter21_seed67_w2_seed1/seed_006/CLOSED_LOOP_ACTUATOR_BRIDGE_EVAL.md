...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_08nbdgpx_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_sent_target_velocity_p95_rad_s` | 1.5533 | NA |
...
| `min_base_height_m` | 0.1579 | 0.1200 |
| `min_reward_mean` | 0.4558 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3061 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0555 | NA |
| `max_forward_shortfall_cost_mean` | 0.3054 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1824 | 0.1579 | 0.0245 | 0.3061 | 0.4558 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 92.9333 | 0.0124 | 0.0115 | 22.6667 | 77.3333 | 114 |
| fitted | `right` | 84.4000 | 0.0175 | 0.0158 | 22.6667 | 77.3333 | 114 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0211 | 0.0345 | 0.4583 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0055 | 0.0089 | 0.0109 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3796 | 0.7294 | 1.0710 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0613 | 0.0857 | 0.0919 |
...
| fitted | `reward/imitation` | 0.6311 | 3.4351 | 4.3323 |
| fitted | `reward/tracking_ang_vel` | 0.5296 | 4.6195 | 6.0000 |
| fitted | `reward/tracking_lin_vel` | 1.6535 | 2.4906 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3061 | 1.2181 | 0.3427 | 0.3054 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3470 | 1.2751 | 0.0878 | 0.1397 | 4 | 0.00 |
| fitted | left_knee | 1.5462 | 1.4853 | 0.1034 | 0.1854 | 4 | 0.00 |
| fitted | left_ankle | 1.3712 | 1.3010 | 0.0891 | 0.1450 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3385 | 1.2515 | 0.0821 | 0.1221 | 4 | 0.00 |
| fitted | right_knee | 1.5533 | 1.4753 | 0.1029 | 0.1729 | 4 | 0.00 |
| fitted | right_ankle | 1.3669 | 1.3103 | 0.0884 | 0.1482 | 4 | 0.00 |
