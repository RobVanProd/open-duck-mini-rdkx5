...
policy: `/home/lsd/robots/open-duck-mini-rdkx5/policy/candidates/phase2_z0075_iter21_balanced_seed67_weight2_plus_seed1_rate150_20260704/candidate.onnx`
...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_o6eb23ar_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1863 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5414 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1775 | 0.2500 |
| `min_base_height_m` | 0.1586 | 0.1200 |
| `min_reward_mean` | 0.4584 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3545 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0516 | NA |
| `max_forward_shortfall_cost_mean` | 0.2389 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1775 | 0.1586 | 0.0284 | 0.3545 | 0.4584 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 92.1333 | 0.0155 | 0.0133 | 24.9333 | 75.0667 | 120 |
| fitted | `right` | 82.9333 | 0.0177 | 0.0156 | 24.9333 | 75.0667 | 120 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0213 | 0.0346 | 0.4583 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0055 | 0.0089 | 0.0110 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4262 | 0.7294 | 1.0710 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0393 | 0.0570 | 0.0654 |
...
| fitted | `reward/imitation` | 0.6290 | 3.4216 | 4.3323 |
| fitted | `reward/tracking_ang_vel` | 0.5838 | 4.6319 | 5.9988 |
| fitted | `reward/tracking_lin_vel` | 1.7363 | 2.4924 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3545 | 1.1340 | 0.2856 | 0.2389 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 13 | 12 | 0.9231 | 0.1017 | 0.1235 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3573 | 1.2984 | 0.0888 | 0.1408 | 4 | 0.00 |
| fitted | left_knee | 1.5414 | 1.4852 | 0.1032 | 0.1863 | 4 | 0.00 |
| fitted | left_ankle | 1.3719 | 1.3078 | 0.0893 | 0.1408 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3457 | 1.2429 | 0.0826 | 0.1189 | 4 | 0.00 |
| fitted | right_knee | 1.5362 | 1.4695 | 0.1033 | 0.1725 | 4 | 0.00 |
| fitted | right_ankle | 1.3577 | 1.2763 | 0.0876 | 0.1501 | 4 | 0.00 |
