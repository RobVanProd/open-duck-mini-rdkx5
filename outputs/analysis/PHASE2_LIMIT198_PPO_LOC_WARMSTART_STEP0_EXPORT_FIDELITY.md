...
- BC NPZ: `outputs/analysis/phase2_limit198_ppo_loc_warmstart_candidate/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/phase2_limit198_ppo_loc_warmstart_candidate/candidate.onnx`
- manifest: `outputs/analysis/phase2_iter2_right_ankle_limit198_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/phase2_limit198_ppo_loc_warmstart_step0_checkpoint`
- exported ONNX: `outputs/analysis/phase2_limit198_ppo_loc_warmstart_step0.onnx`
