...
- MAE: `0.009664`
- p95 abs error: `0.025093`
- max abs error: `0.206191`
- target-rate p95: `1.391938` rad/s
- target-rate max: `2.173065` rad/s

## ONNX Verification

- steps checked: `64`
- max action error: `0.00000038`
...
tools/run_candidate_seed_sweep.py \
  --policies recurrent=outputs/analysis/phase2_health_routed_parent_live_compact_iter2_recurrent_h96_s32/candidate.onnx \
