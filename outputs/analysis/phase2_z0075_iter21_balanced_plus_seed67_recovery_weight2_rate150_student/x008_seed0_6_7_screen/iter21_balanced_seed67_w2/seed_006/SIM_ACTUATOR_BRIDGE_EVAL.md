...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_gyp7uls1_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1853 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.6013 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1889 | 0.2500 |
| `min_base_height_m` | 0.1580 | 0.1200 |
| `min_reward_mean` | 0.4576 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3438 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0525 | NA |
| `max_forward_shortfall_cost_mean` | 0.2532 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1889 | 0.1580 | 0.0275 | 0.3438 | 0.4576 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 94.6667 | 0.0150 | 0.0127 | 24.1333 | 75.8667 | 112 |
| fitted | `right` | 81.2000 | 0.0208 | 0.0166 | 24.1333 | 75.8667 | 112 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0214 | 0.0372 | 0.4272 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0056 | 0.0090 | 0.0114 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4057 | 0.7166 | 1.0700 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0480 | 0.0702 | 0.0810 |
...
| fitted | `reward/imitation` | 0.5949 | 3.2406 | 4.3583 |
| fitted | `reward/tracking_ang_vel` | 0.6217 | 4.9161 | 5.9999 |
| fitted | `reward/tracking_lin_vel` | 1.6912 | 2.4940 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3438 | 1.2119 | 0.3117 | 0.2532 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 13 | 12 | 0.9231 | 0.1051 | 0.1242 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3554 | 1.2710 | 0.0862 | 0.1409 | 4 | 0.00 |
| fitted | left_knee | 1.6013 | 1.5182 | 0.1045 | 0.1853 | 4 | 0.00 |
| fitted | left_ankle | 1.3464 | 1.2764 | 0.0883 | 0.1446 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4401 | 1.3278 | 0.0891 | 0.1265 | 4 | 0.00 |
| fitted | right_knee | 1.5983 | 1.5199 | 0.1069 | 0.1756 | 4 | 0.00 |
| fitted | right_ankle | 1.4093 | 1.3398 | 0.0903 | 0.1498 | 4 | 0.00 |
