...
policy: `/home/lsd/robots/open-duck-mini-rdkx5/policy/candidates/phase2_z0075_iter21_balanced_plus_seed67_recovery_weight2_rate150_20260704/candidate.onnx`
...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_kc9zy_da_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1842 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5992 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1813 | 0.2500 |
| `min_base_height_m` | 0.1582 | 0.1200 |
| `min_reward_mean` | 0.4604 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3618 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0511 | NA |
| `max_forward_shortfall_cost_mean` | 0.2171 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1813 | 0.1582 | 0.0289 | 0.3618 | 0.4604 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 92.2667 | 0.0155 | 0.0126 | 24.4000 | 75.6000 | 114 |
| fitted | `right` | 83.3333 | 0.0172 | 0.0155 | 24.4000 | 75.6000 | 114 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0215 | 0.0366 | 0.4272 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0056 | 0.0090 | 0.0121 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4032 | 0.7166 | 1.0700 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0485 | 0.0761 | 0.0954 |
...
| fitted | `reward/imitation` | 0.6428 | 3.3218 | 4.3583 |
| fitted | `reward/tracking_ang_vel` | 0.6978 | 5.0528 | 5.9999 |
| fitted | `reward/tracking_lin_vel` | 1.7060 | 2.4890 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3618 | 1.2305 | 0.2880 | 0.2171 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 12 | 11 | 0.9167 | 0.1073 | 0.1215 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3617 | 1.2818 | 0.0867 | 0.1407 | 4 | 0.00 |
| fitted | left_knee | 1.5931 | 1.5190 | 0.1046 | 0.1842 | 4 | 0.00 |
| fitted | left_ankle | 1.3864 | 1.2872 | 0.0874 | 0.1426 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4210 | 1.3438 | 0.0884 | 0.1277 | 4 | 0.00 |
| fitted | right_knee | 1.5992 | 1.5298 | 0.1073 | 0.1713 | 4 | 0.00 |
| fitted | right_ankle | 1.3999 | 1.3173 | 0.0897 | 0.1533 | 4 | 0.00 |
