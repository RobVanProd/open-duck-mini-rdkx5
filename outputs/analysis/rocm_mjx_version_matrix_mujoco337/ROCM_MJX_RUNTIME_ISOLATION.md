...
|---|---|---|---|---|---:|---:|---|
| `default_gpu_basic_jax` | `default` | `gpu` | `basic_jax` | `PASS` | `0` | 1.89 | NA |
| `default_gpu_minimal_mjx_step` | `default` | `gpu` | `minimal_mjx_step` | `PASS` | `0` | 9.48 | 1:PASS |
| `default_gpu_playground_contract_only` | `default` | `gpu` | `playground_contract_only` | `PASS` | `0` | 3.26 | NA |
| `default_gpu_playground_reset` | `default` | `gpu` | `playground_reset` | `PASS` | `0` | 43.77 | NA |
| `default_gpu_playground_direct_mjx_step` | `default` | `gpu` | `playground_direct_mjx_step` | `TIMEOUT` | `None` | 120.22 | NA |
| `default_cpu_basic_jax` | `default` | `cpu` | `basic_jax` | `PASS` | `0` | 0.93 | NA |
| `default_cpu_minimal_mjx_step` | `default` | `cpu` | `minimal_mjx_step` | `PASS` | `0` | 5.82 | 1:PASS |
| `default_cpu_playground_contract_only` | `default` | `cpu` | `playground_contract_only` | `PASS` | `0` | 1.93 | NA |
| `default_cpu_playground_reset` | `default` | `cpu` | `playground_reset` | `PASS` | `0` | 35.31 | NA |
| `default_cpu_playground_direct_mjx_step` | `default` | `cpu` | `playground_direct_mjx_step` | `PASS` | `0` | 38.26 | NA |

## Failing Output Excerpts

### default_gpu_playground_direct_mjx_step

- stdout: `/home/lsd/robots/open-duck-mini-rdkx5/outputs/analysis/rocm_mjx_version_matrix_mujoco337/default_gpu_playground_direct_mjx_step.stdout.txt`
- stderr: `/home/lsd/robots/open-duck-mini-rdkx5/outputs/analysis/rocm_mjx_version_matrix_mujoco337/default_gpu_playground_direct_mjx_step.stderr.txt`

```text
/home/lsd/robots/envs/open-duck-playground-rocm-mujoco337/lib/python3.12/site-packages/jax/_src/abstract_arrays.py:135: RuntimeWarning: overflow encountered in cast
