...
- BC NPZ: `outputs/analysis/ppo_loc_dagger6_recovery_student_candidate/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/ppo_loc_dagger6_recovery_student_candidate/candidate.onnx`
- manifest: `outputs/analysis/filtered_source_vx_selector_dagger6_recovery_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/ppo_loc_dagger6_recovery_step0_checkpoint`
- exported ONNX: `outputs/analysis/ppo_loc_dagger6_recovery_step0.onnx`
