...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0027, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_bye4ax5z_hfield_z0.0027.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1870 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.8734 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.2832 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0717 | 0.2500 |
| `min_base_height_m` | 0.0650 | 0.1200 |
| `min_reward_mean` | 0.4129 | 0.3000 |
| `min_forward_command_tracking_ratio` | -3.1937 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.3355 | NA |
| `max_forward_shortfall_cost_mean` | 39.8777 | NA |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 89.6552 | 0.0289 | 0.0288 | 6.8966 | 84.4828 | 8 |
| fitted | `right` | 86.2069 | 0.0448 | 0.0404 | 6.8966 | 84.4828 | 8 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0250 | 0.0446 | 0.2230 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0062 | 0.0219 | 0.0570 |
...
| fitted | `diagnostic/command_progress_ratio` | -0.0389 | 1.7669 | 1.9172 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 1.2992 | 9.3783 | 14.3923 |
...
| fitted | `reward/imitation` | -0.1474 | 3.0432 | 3.2582 |
| fitted | `reward/tracking_ang_vel` | 0.3716 | 2.8378 | 5.9976 |
| fitted | `reward/tracking_lin_vel` | 0.4526 | 1.9084 | 2.4866 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -3.1937 | 2.1540 | 3.8787 | 39.8777 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.7290 | 1.5555 | 0.0933 | 0.1106 | 3 | 0.00 |
| fitted | left_knee | 1.8734 | 1.6553 | 0.1051 | 0.1870 | 3 | 0.00 |
| fitted | left_ankle | 1.0992 | 0.9849 | 0.0712 | 0.1669 | 4 | 0.00 |
| fitted | right_hip_pitch | 0.9250 | 0.8141 | 0.0507 | 0.1748 | 3 | 0.00 |
| fitted | right_knee | 1.7011 | 1.4169 | 0.0750 | 0.1641 | 3 | 0.00 |
| fitted | right_ankle | 1.7628 | 1.3122 | 0.0730 | 0.1341 | 3 | 0.00 |
