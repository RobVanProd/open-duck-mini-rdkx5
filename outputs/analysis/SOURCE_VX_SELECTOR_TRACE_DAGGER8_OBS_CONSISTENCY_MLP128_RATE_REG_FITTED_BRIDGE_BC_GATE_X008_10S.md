...
- train_rmse: `0.0267`
- train_mae: `0.0174`
- train_p95_abs_error: `0.0533`
- train_max_abs_error: `0.3141`
...
- saved_npz: `outputs/analysis/source_vx_selector_trace_dagger8_obs_consistency_mlp128_rate_reg_candidate/candidate_mlp.npz`
- exported_onnx: `outputs/analysis/source_vx_selector_trace_dagger8_obs_consistency_mlp128_rate_reg_candidate/candidate.onnx`
...
|---|---:|---|---:|---:|---:|---:|---:|---:|---:|
| seed_000 | 500 | duration_complete | 0.0311 | 0.3889 | 0.1059 | 0.0542 | 0.1536 | 2.2585 | 0.1764 |
| seed_001 | 33 | fall_or_progress_failure | 0.0067 | 0.0836 | 1.2433 | 0.1666 | 0.0791 | 2.2362 | 0.1577 |
| seed_002 | 500 | duration_complete | 0.0316 | 0.3952 | 0.1090 | 0.0599 | 0.1525 | 2.2285 | 0.1777 |
| seed_003 | 500 | duration_complete | 0.0297 | 0.3709 | 0.1165 | 0.0566 | 0.1590 | 2.2430 | 0.1784 |
| seed_004 | 500 | duration_complete | 0.0305 | 0.3813 | 0.1105 | 0.0620 | 0.1515 | 2.2955 | 0.1803 |
| seed_005 | 500 | duration_complete | 0.0321 | 0.4014 | 0.1105 | 0.1831 | 0.1469 | 2.2591 | 0.1779 |
| seed_006 | 500 | duration_complete | 0.0254 | 0.3180 | 0.1176 | 0.0612 | 0.1587 | 2.2793 | 0.1809 |
| seed_007 | 32 | fall_or_progress_failure | 0.0202 | 0.2524 | 1.1534 | 0.0335 | 0.0848 | 2.5541 | 0.1703 |

### Rollout Action Summary

| seed | action_abs_mean | action_delta_p95_per_s | action_saturation_pct |
|---|---:|---:|---:|
| seed_000 | 0.3335 | 9.0268 | 0.0000 |
| seed_001 | 0.3180 | 8.9446 | 0.0000 |
| seed_002 | 0.3337 | 8.9032 | 0.0000 |
| seed_003 | 0.3336 | 8.9718 | 0.0000 |
| seed_004 | 0.3348 | 9.1822 | 0.0000 |
| seed_005 | 0.3344 | 9.0266 | 0.0000 |
| seed_006 | 0.3342 | 9.1172 | 0.0000 |
| seed_007 | 0.3124 | 10.2166 | 0.0000 |
