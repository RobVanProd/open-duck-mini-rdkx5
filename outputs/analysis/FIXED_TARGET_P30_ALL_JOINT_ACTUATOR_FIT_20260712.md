...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| left_hip_yaw | 3 | 60.0 | 0.015 | 1.00 | 0.0072 | 0.0037 | 0.0033 | 0.0072 | 0.0377 | 0.0843 | 0.0630 | 0.747 | 0.9437 | 0.7013 | 3 | GOOD | none |
| left_hip_roll | 3 | 60.0 | 0.015 | 0.75 | 0.0118 | 0.0068 | 0.0063 | 0.0118 | 0.0484 | 0.1070 | 0.0920 | 0.860 | 0.8688 | 0.7045 | 3 | GOOD | none |
...
| neck_pitch | 3 | 60.0 | 0.120 | 0.50 | 0.0202 | 0.0118 | 0.0111 | 0.0202 | 0.0393 | 0.0823 | 0.0260 | 0.316 | 0.8378 | 0.1003 | 5 | GOOD | tau_s hit upper grid bound, velocity limit hit lower grid bound |
| head_pitch | 2 | 40.0 | 0.120 | 0.50 | 0.0050 | 0.0026 | 0.0023 | 0.0050 | 0.0210 | 0.0556 | 0.0430 | 0.773 | 0.7236 | 0.1996 | 4 | GOOD | tau_s hit upper grid bound, velocity limit hit lower grid bound |
| head_yaw | 3 | 60.0 | 0.120 | 0.50 | 0.0100 | 0.0053 | 0.0047 | 0.0100 | 0.0463 | 0.1241 | 0.0480 | 0.387 | 0.8829 | 0.2499 | 6 | GOOD | tau_s hit upper grid bound, velocity limit hit lower grid bound |
| head_roll | 3 | 60.0 | 0.120 | 0.50 | 0.0088 | 0.0044 | 0.0039 | 0.0088 | 0.0259 | 0.0760 | 0.0400 | 0.526 | 0.5834 | 0.2000 | 5 | GOOD | tau_s hit upper grid bound, velocity limit hit lower grid bound |
| right_hip_yaw | 3 | 60.0 | 0.020 | 0.50 | 0.0055 | 0.0028 | 0.0024 | 0.0055 | 0.0229 | 0.0489 | 0.0420 | 0.858 | 0.6198 | 0.4008 | 3 | GOOD | velocity limit hit lower grid bound |
| right_hip_roll | 2 | 40.0 | 0.035 | 0.75 | 0.0101 | 0.0059 | 0.0055 | 0.0101 | 0.0420 | 0.1075 | 0.0810 | 0.753 | 0.9149 | 0.6507 | 3 | GOOD | none |
...
|---|---:|---:|---:|---:|---|
| left_hip_yaw | 0.0046 | 0.0097 | 0.0153 | 0.0037 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| left_hip_roll | 0.0076 | 0.0117 | 0.0174 | 0.0068 | delay improves over lag-only; lag/delay improves over velocity-only |
...
| neck_pitch | 0.0170 | 0.0124 | 0.0174 | 0.0118 | lag/velocity improves over delay-only; lag/delay improves over velocity-only |
| head_pitch | 0.0078 | 0.0036 | 0.0091 | 0.0026 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| head_yaw | 0.0175 | 0.0089 | 0.0230 | 0.0053 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| head_roll | 0.0093 | 0.0055 | 0.0126 | 0.0044 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| right_hip_yaw | 0.0043 | 0.0059 | 0.0112 | 0.0028 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| right_hip_roll | 0.0072 | 0.0103 | 0.0166 | 0.0059 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
