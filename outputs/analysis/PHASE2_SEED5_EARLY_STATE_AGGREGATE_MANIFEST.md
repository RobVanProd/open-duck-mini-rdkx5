...
- `outputs/analysis/phase2_live_oracle_right_swing_iter1_seed5_capped_aggregate_manifest.json`
- `outputs/analysis/phase2_seed5_early_state_x008_manifest.json`
- `outputs/analysis/phase2_seed5_early_state_x0_manifest.json`
