...
- BC NPZ: `outputs/analysis/phase2_health_routed_parent_seed5_equal_ppo_loc_rate150_prior/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/phase2_health_routed_parent_seed5_equal_ppo_loc_rate150_prior/candidate.onnx`
- manifest: `outputs/analysis/phase2_health_routed_parent_seed5_augmented_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/phase2_health_routed_parent_seed5_equal_ppo_loc_rate150_step0_checkpoint`
- exported ONNX: `outputs/analysis/phase2_health_routed_parent_seed5_equal_ppo_loc_rate150_step0.onnx`
