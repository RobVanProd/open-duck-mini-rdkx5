...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| left_hip_pitch | 3 | 60.3 | 0.020 | 2.50 | 0.0132 | 0.0149 | 0.0132 | 0.0252 | 0.1736 | 0.3493 | 0.2760 | 0.790 | 5.2170 | 2.4047 | 4 | GOOD | tau_s hit lower grid bound |
| left_knee | 3 | 60.3 | 0.020 | 3.50 | 0.0151 | 0.0169 | 0.0151 | 0.0333 | 0.1793 | 0.3430 | 0.3230 | 0.942 | 3.7814 | 2.9371 | 3 | GOOD | tau_s hit lower grid bound |
| left_ankle | 3 | 60.3 | 0.020 | 3.00 | 0.0097 | 0.0106 | 0.0097 | 0.0193 | 0.1325 | 0.2444 | 0.2030 | 0.831 | 3.7399 | 2.1407 | 3 | GOOD | tau_s hit lower grid bound |
| right_hip_pitch | 3 | 60.3 | 0.020 | 3.50 | 0.0139 | 0.0155 | 0.0139 | 0.0286 | 0.1661 | 0.2492 | 0.2700 | 1.083 | 3.1013 | 2.6398 | 3 | GOOD | tau_s hit lower grid bound |
| right_knee | 3 | 60.3 | 0.020 | 3.50 | 0.0167 | 0.0195 | 0.0167 | 0.0349 | 0.2062 | 0.3608 | 0.3210 | 0.890 | 4.8109 | 3.1864 | 3 | GOOD | tau_s hit lower grid bound |
| right_ankle | 3 | 60.3 | 0.020 | 2.50 | 0.0126 | 0.0146 | 0.0126 | 0.0282 | 0.1428 | 0.2796 | 0.2470 | 0.883 | 3.5230 | 2.1408 | 3 | GOOD | tau_s hit lower grid bound |

## Model Family Comparison

| joint | delay_only_rmse | first_order_rmse | velocity_only_rmse | combined_rmse | support |
|---|---:|---:|---:|---:|---|
| left_hip_pitch | 0.0302 | 0.0411 | 0.0466 | 0.0149 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
...
| right_knee | 0.0301 | 0.0617 | 0.0680 | 0.0195 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| right_ankle | 0.0227 | 0.0370 | 0.0445 | 0.0146 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
...
| left_ankle | 0.0073 | 0.1101 | 0.0018 | 0.0031 |
