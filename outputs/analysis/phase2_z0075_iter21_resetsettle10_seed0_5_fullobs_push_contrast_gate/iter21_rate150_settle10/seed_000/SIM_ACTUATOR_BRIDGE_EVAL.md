...
policy: `/home/lsd/robots/open-duck-mini-rdkx5/policy/candidates/phase2_z0075_iter21_early_lunge_gain095_rate150_20260704/candidate.onnx`
...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_a9hvfqe3_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1827 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.6164 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1628 | 0.2500 |
| `min_base_height_m` | 0.1593 | 0.1200 |
| `min_reward_mean` | 0.4569 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3391 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0529 | NA |
| `max_forward_shortfall_cost_mean` | 0.2237 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1628 | 0.1593 | 0.0271 | 0.3391 | 0.4569 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 91.7333 | 0.0140 | 0.0115 | 24.9333 | 75.0667 | 132 |
| fitted | `right` | 83.3333 | 0.0185 | 0.0139 | 24.9333 | 75.0667 | 132 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0212 | 0.0370 | 0.1614 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0089 | 0.0103 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3941 | 0.6700 | 1.0592 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0516 | 0.0728 | 0.0777 |
...
| fitted | `reward/imitation` | 0.6141 | 3.3644 | 4.2040 |
| fitted | `reward/tracking_ang_vel` | 0.5655 | 4.4256 | 5.9959 |
| fitted | `reward/tracking_lin_vel` | 1.6922 | 2.4862 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3391 | 1.2007 | 0.2939 | 0.2237 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3651 | 1.2846 | 0.0873 | 0.1387 | 4 | 0.00 |
| fitted | left_knee | 1.5634 | 1.4813 | 0.1019 | 0.1827 | 4 | 0.00 |
| fitted | left_ankle | 1.3312 | 1.2499 | 0.0855 | 0.1395 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3814 | 1.2909 | 0.0836 | 0.1175 | 4 | 0.00 |
| fitted | right_knee | 1.6164 | 1.5068 | 0.1036 | 0.1738 | 4 | 0.00 |
| fitted | right_ankle | 1.4030 | 1.3315 | 0.0902 | 0.1515 | 4 | 0.00 |
