...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_5ks19o9l_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1786 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.6282 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1735 | 0.2500 |
| `min_base_height_m` | 0.0630 | 0.1200 |
| `min_reward_mean` | 0.4516 | 0.3000 |
| `min_forward_command_tracking_ratio` | -0.0672 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0854 | NA |
| `max_forward_shortfall_cost_mean` | 4.3261 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 599 | fall_or_nan | 0.1735 | 0.0630 | -0.0054 | -0.0672 | 0.4516 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 91.8197 | 0.0337 | 0.0173 | 23.2053 | 76.4608 | 88 |
| fitted | `right` | 84.3072 | 0.0342 | 0.0217 | 23.2053 | 76.4608 | 88 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0211 | 0.0376 | 0.1614 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0089 | 0.0114 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3933 | 0.7273 | 1.0592 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0570 | 0.1055 | 0.4451 |
...
| fitted | `reward/imitation` | 0.5660 | 3.3004 | 4.2494 |
| fitted | `reward/tracking_ang_vel` | 0.5317 | 4.6092 | 5.9999 |
| fitted | `reward/tracking_lin_vel` | 1.5080 | 2.4839 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -0.0672 | 1.1830 | 0.7014 | 4.3261 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 10 | 9 | 0.9000 | 0.1010 | 0.1183 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3786 | 1.2717 | 0.0874 | 0.1372 | 4 | 0.00 |
| fitted | left_knee | 1.5587 | 1.4824 | 0.1007 | 0.1781 | 4 | 0.00 |
| fitted | left_ankle | 1.3258 | 1.2279 | 0.0847 | 0.1365 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3624 | 1.2866 | 0.0847 | 0.1206 | 4 | 0.00 |
| fitted | right_knee | 1.6282 | 1.5077 | 0.1043 | 0.1786 | 4 | 0.00 |
| fitted | right_ankle | 1.3898 | 1.3337 | 0.0911 | 0.1484 | 4 | 0.00 |
