...
| 0.074 | 167931544 | `PASS_CANDIDATE_SIM_GATE` | `True` | `duration_complete` | 0.9950653144787066 | 169 | none |
| 0.077 | 167931544 | `PASS_CANDIDATE_SIM_GATE` | `True` | `duration_complete` | 1.1184868387877942 | 144 | none |
| 0.08 | 167931544 | `PASS_CANDIDATE_SIM_GATE` | `True` | `duration_complete` | 1.200551526574418 | 125 | none |
