...
No scales, calipers, mass, COM, inertia, dimensions, component identity, or manual per-build input is used. No zero-PPO run, training, hosted compute, runtime implementation, X5/robot access, torque, motion, Gate 5, deployment, checkpoint selection, or robot clearance is authorized.
