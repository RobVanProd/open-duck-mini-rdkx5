...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0025, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_ahjilkge_hfield_z0.0025.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.2106 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 0.5823 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0553 | 0.2500 |
| `min_base_height_m` | 0.0575 | 0.1200 |
| `min_reward_mean` | 0.4299 | 0.3000 |
| `min_forward_command_tracking_ratio` | NA | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.3468 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 43 | fall_or_nan | -0.0553 | 0.0575 | -0.3468 | NA | 0.4299 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 90.6977 | 0.0304 | 0.0293 | 9.3023 | 86.0465 | 8 |
| fitted | `right` | 90.6977 | 0.0428 | 0.0401 | 9.3023 | 86.0465 | 8 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0014 | 0.0062 | 0.0133 |
| fitted | `cost/stand_still` | 0.8400 | 4.7048 | 5.6738 |
| fitted | `cost/torques` | 0.0046 | 0.0330 | 0.0543 |
...
| fitted | `reward/tracking_ang_vel` | 1.8792 | 5.8728 | 5.9762 |
| fitted | `reward/tracking_lin_vel` | 0.4600 | 1.9389 | 2.4414 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 0.5823 | 0.3391 | 0.0185 | 0.0316 | 3 | 0.00 |
| fitted | left_knee | 0.2741 | 0.1312 | 0.0083 | 0.2074 | 3 | 0.00 |
| fitted | left_ankle | 0.5597 | 0.2726 | 0.0113 | 0.0897 | 3 | 0.00 |
| fitted | right_hip_pitch | 0.3632 | 0.1917 | 0.0119 | 0.1441 | 3 | 0.00 |
| fitted | right_knee | 0.2367 | 0.0932 | 0.0163 | 0.2106 | 4 | 0.00 |
| fitted | right_ankle | 0.3721 | 0.2351 | 0.0176 | 0.1169 | 3 | 0.00 |
