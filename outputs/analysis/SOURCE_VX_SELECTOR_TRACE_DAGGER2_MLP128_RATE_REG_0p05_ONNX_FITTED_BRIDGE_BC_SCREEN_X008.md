...
- train_rmse: `0.0249`
- train_mae: `0.0165`
- train_p95_abs_error: `0.0499`
- train_max_abs_error: `0.3159`
...
- learning_rate: `0.001`
- pair_count: `8744`
- target_rate_scale: `0.05`
- target_rate_limit_rad_s: `3.75`
- obs_noise_std: `0.0`
- obs_consistency_scale: `0.0`
- saved_npz: `outputs/analysis/source_vx_selector_trace_dagger2_mlp128_rate_reg_0p05_candidate/candidate_mlp.npz`
- exported_onnx: `outputs/analysis/source_vx_selector_trace_dagger2_mlp128_rate_reg_0p05_candidate/candidate.onnx`
...
|---|---:|---|---:|---:|---:|---:|---:|---:|---:|
| seed_000 | 500 | duration_complete | 0.0382 | 0.4775 | 0.1391 | 0.0910 | 0.1520 | 2.1811 | 0.1796 |
| seed_003 | 500 | duration_complete | 0.0347 | 0.4343 | 0.1347 | 0.1018 | 0.1547 | 2.1961 | 0.1749 |

### Rollout Action Summary

| seed | action_abs_mean | action_delta_p95_per_s | action_saturation_pct |
|---|---:|---:|---:|
| seed_000 | 0.3326 | 8.7243 | 0.0000 |
| seed_003 | 0.3323 | 8.7844 | 0.0000 |
