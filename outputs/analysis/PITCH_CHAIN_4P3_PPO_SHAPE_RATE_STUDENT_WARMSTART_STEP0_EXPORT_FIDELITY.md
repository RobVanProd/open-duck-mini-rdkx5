...
- reference ONNX: `outputs/analysis/pitch_chain_4p3_ppo_shape_rate_student_candidate/candidate.onnx`
- manifest: `outputs/analysis/source_vx_selector_trace_pitch_chain_rate_limited_4p3_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/pitch_chain_4p3_ppo_shape_rate_student_warmstart_checkpoint`
- exported ONNX: `outputs/analysis/pitch_chain_4p3_ppo_shape_rate_student_warmstart_step0.onnx`
