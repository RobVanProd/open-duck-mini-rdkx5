...
- NPZ: `outputs/analysis/phase2_z0026_corrected_source_live_oracle_iter1_phase_contact_rate165_student/candidate_mlp.npz`
- ONNX: `outputs/analysis/phase2_z0026_corrected_source_live_oracle_iter1_phase_contact_rate165_student/candidate.onnx`

## Fit Metrics

- MAE: `0.006750`
- p95 abs error: `0.017565`
- max abs error: `0.298686`
