...
policy: `/home/lsd/robots/open-duck-mini-rdkx5/outputs/analysis/colab_hardware_vector_results/extracted/2026_07_12_151415_163840.onnx`
...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0026, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_p_mvjbk7_hfield_z0.0026.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.0507 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 0.2600 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0187 | 0.2500 |
| `min_base_height_m` | 0.1523 | 0.1200 |
| `min_reward_mean` | 0.4843 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.0036 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0797 | NA |
| `max_forward_shortfall_cost_mean` | 0.2522 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.0187 | 0.1523 | 0.0003 | 0.0036 | 0.4843 |
...
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0006 | 0.0008 | 0.0965 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0010 | 0.0013 | 0.0023 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.0029 | 0.0131 | 0.0525 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.3307 | 0.3561 | 0.3574 |
...
| fitted | `reward/imitation` | 0.8588 | 2.8494 | 3.3059 |
| fitted | `reward/tracking_ang_vel` | 2.0297 | 5.8950 | 6.0000 |
| fitted | `reward/tracking_lin_vel` | 1.3259 | 1.4730 | 1.7182 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.0036 | 0.0909 | 0.4964 | 0.2522 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 0.1882 | 0.1891 | 0.0111 | 0.0241 | 3 | 0.00 |
| fitted | left_knee | 0.1211 | 0.1167 | 0.0069 | 0.0398 | 3 | 0.00 |
| fitted | left_ankle | 0.2136 | 0.2142 | 0.0129 | 0.0219 | 3 | 0.00 |
| fitted | right_hip_pitch | 0.1763 | 0.1748 | 0.0106 | 0.0278 | 3 | 0.00 |
| fitted | right_knee | 0.2600 | 0.2330 | 0.0143 | 0.0507 | 3 | 0.00 |
| fitted | right_ankle | 0.1781 | 0.1776 | 0.0099 | 0.0177 | 3 | 0.00 |
