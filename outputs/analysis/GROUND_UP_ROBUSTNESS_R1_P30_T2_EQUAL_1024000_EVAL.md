...
| 0.074 | 167931544 | `PASS_CANDIDATE_SIM_GATE` | `True` | `duration_complete` | 1.1422745115403086 | 155 | none |
| 0.077 | 167931544 | `PASS_CANDIDATE_SIM_GATE` | `True` | `duration_complete` | 1.2236480940226466 | 146 | none |
| 0.08 | 167931544 | `PASS_CANDIDATE_SIM_GATE` | `True` | `duration_complete` | 1.1858286442328245 | 148 | none |
