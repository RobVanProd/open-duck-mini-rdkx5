...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.00255, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_ij3twv47_hfield_z0.00255.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1921 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.2397 | NA |
...
| `min_base_height_m` | 0.0640 | 0.1200 |
| `min_reward_mean` | 0.4069 | 0.3000 |
| `min_forward_command_tracking_ratio` | NA | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.2393 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 62 | fall_or_nan | -0.0771 | 0.0640 | -0.2393 | NA | 0.4069 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 90.3226 | 0.0302 | 0.0296 | 8.0645 | 87.0968 | 8 |
| fitted | `right` | 91.9355 | 0.0431 | 0.0403 | 8.0645 | 87.0968 | 8 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0147 | 0.0239 | 0.4752 |
| fitted | `cost/stand_still` | 1.3845 | 4.8395 | 6.2840 |
| fitted | `cost/torques` | 0.0053 | 0.0242 | 0.0580 |
...
| fitted | `reward/tracking_ang_vel` | 0.7821 | 4.8495 | 5.9916 |
| fitted | `reward/tracking_lin_vel` | 0.9688 | 2.4946 | 2.4982 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.1843 | 1.1239 | 0.0789 | 0.1012 | 4 | 0.00 |
| fitted | left_knee | 1.1775 | 1.0303 | 0.0684 | 0.1794 | 4 | 0.00 |
| fitted | left_ankle | 1.0458 | 1.2284 | 0.0989 | 0.1921 | 4 | 0.00 |
| fitted | right_hip_pitch | 0.7654 | 0.9704 | 0.0683 | 0.1365 | 4 | 0.00 |
| fitted | right_knee | 1.2397 | 1.1230 | 0.0741 | 0.1452 | 4 | 0.00 |
| fitted | right_ankle | 0.6243 | 0.7337 | 0.0582 | 0.1189 | 4 | 0.00 |
