...
- reference ONNX: `outputs/analysis/ppo_loc_swish_seed5_recovery_candidate/candidate.onnx`
- manifest: `outputs/analysis/ppo_swish_seed5_recovery_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/ppo_bc_swish_seed5_recovery_step0_checkpoint`
- exported ONNX: `outputs/analysis/ppo_bc_swish_seed5_recovery_step0.onnx`
