...
- BC NPZ: `outputs/analysis/ppo_loc_dagger7_targeted_recovery_student_candidate/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/ppo_loc_dagger7_targeted_recovery_student_candidate/candidate.onnx`
