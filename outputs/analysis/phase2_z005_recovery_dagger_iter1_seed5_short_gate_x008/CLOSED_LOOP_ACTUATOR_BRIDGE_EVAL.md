...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.005, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_xme8hbxc_hfield_z0.005.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1801 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.8071 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0399 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0821 | 0.2500 |
| `min_base_height_m` | 0.0684 | 0.1200 |
| `min_reward_mean` | 0.4121 | 0.3000 |
| `min_forward_command_tracking_ratio` | -2.9251 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.3140 | NA |
| `max_forward_shortfall_cost_mean` | 36.8668 | NA |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 90.6250 | 0.0310 | 0.0305 | 9.3750 | 85.9375 | 10 |
| fitted | `right` | 90.6250 | 0.0428 | 0.0399 | 9.3750 | 85.9375 | 10 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0199 | 0.0281 | 0.2881 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0064 | 0.0200 | 0.0579 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.0325 | 1.8487 | 1.9913 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 1.2179 | 7.5948 | 12.4262 |
...
| fitted | `reward/imitation` | -0.1607 | 2.8193 | 3.2378 |
| fitted | `reward/tracking_ang_vel` | 0.3026 | 2.2766 | 5.8518 |
| fitted | `reward/tracking_lin_vel` | 0.4895 | 1.7671 | 2.4989 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -2.9251 | 2.1268 | 3.5974 | 36.8668 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.1558 | 1.0698 | 0.0672 | 0.1104 | 4 | 0.00 |
| fitted | left_knee | 1.8071 | 1.6978 | 0.1075 | 0.1801 | 4 | 0.00 |
| fitted | left_ankle | 1.2064 | 1.2322 | 0.0824 | 0.1710 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.0623 | 1.0237 | 0.0672 | 0.1697 | 4 | 0.00 |
| fitted | right_knee | 1.3571 | 1.1682 | 0.0736 | 0.1780 | 3 | 0.00 |
| fitted | right_ankle | 1.2836 | 1.2033 | 0.0788 | 0.1343 | 4 | 0.00 |
