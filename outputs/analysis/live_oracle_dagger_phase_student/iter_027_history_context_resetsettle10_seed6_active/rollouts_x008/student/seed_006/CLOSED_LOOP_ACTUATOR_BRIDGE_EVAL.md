...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_rcj5wrlk_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1794 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5557 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.2187 | 0.2500 |
| `min_base_height_m` | 0.0690 | 0.1200 |
| `min_reward_mean` | 0.4473 | 0.3000 |
| `min_forward_command_tracking_ratio` | -0.5659 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.1253 | NA |
| `max_forward_shortfall_cost_mean` | 9.2327 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 250 | fall_or_nan | 0.2187 | 0.0690 | -0.0453 | -0.5659 | 0.4473 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 89.6000 | 0.0354 | 0.0145 | 23.2000 | 76.8000 | 50 |
| fitted | `right` | 87.2000 | 0.0338 | 0.0240 | 23.2000 | 76.8000 | 50 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0203 | 0.0355 | 0.1357 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0088 | 0.0102 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4206 | 0.8565 | 1.0059 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0860 | 0.3348 | 1.3594 |
...
| fitted | `reward/imitation` | 0.5142 | 3.3051 | 4.2954 |
| fitted | `reward/tracking_ang_vel` | 0.5524 | 4.6761 | 5.9847 |
| fitted | `reward/tracking_lin_vel` | 1.3236 | 2.4913 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -0.5659 | 1.2510 | 1.2089 | 9.2327 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 4 | 3 | 0.7500 | 0.1136 | 0.1233 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3070 | 1.2255 | 0.0832 | 0.1328 | 4 | 0.00 |
| fitted | left_knee | 1.5368 | 1.4725 | 0.1027 | 0.1794 | 4 | 0.00 |
| fitted | left_ankle | 1.3653 | 1.2913 | 0.0880 | 0.1460 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3873 | 1.3551 | 0.0846 | 0.1244 | 4 | 0.00 |
| fitted | right_knee | 1.5557 | 1.5106 | 0.1059 | 0.1732 | 4 | 0.00 |
| fitted | right_ankle | 1.3742 | 1.3153 | 0.0861 | 0.1392 | 4 | 0.00 |
