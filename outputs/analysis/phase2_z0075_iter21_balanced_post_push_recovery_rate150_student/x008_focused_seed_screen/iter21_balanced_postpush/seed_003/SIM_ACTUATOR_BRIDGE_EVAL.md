...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_u7ea3_hr_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_sent_target_velocity_p95_rad_s` | 1.5814 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1738 | 0.2500 |
| `min_base_height_m` | 0.1584 | 0.1200 |
| `min_reward_mean` | 0.4586 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3979 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0482 | NA |
| `max_forward_shortfall_cost_mean` | 0.2302 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1738 | 0.1584 | 0.0318 | 0.3979 | 0.4586 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 91.4667 | 0.0115 | 0.0111 | 27.4667 | 72.5333 | 132 |
| fitted | `right` | 81.0667 | 0.0218 | 0.0172 | 27.4667 | 72.5333 | 132 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0223 | 0.0375 | 0.4242 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0056 | 0.0089 | 0.0113 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4377 | 0.7445 | 1.0549 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0349 | 0.0506 | 0.0521 |
...
| fitted | `reward/imitation` | 0.6087 | 3.3916 | 4.4503 |
| fitted | `reward/tracking_ang_vel` | 0.5783 | 4.8892 | 5.9991 |
| fitted | `reward/tracking_lin_vel` | 1.7689 | 2.4946 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3979 | 1.2652 | 0.2785 | 0.2302 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 13 | 12 | 0.9231 | 0.1022 | 0.1245 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.4362 | 1.3587 | 0.0921 | 0.1424 | 4 | 0.00 |
| fitted | left_knee | 1.5814 | 1.5026 | 0.1032 | 0.1842 | 4 | 0.00 |
| fitted | left_ankle | 1.3421 | 1.2682 | 0.0871 | 0.1434 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4629 | 1.3356 | 0.0898 | 0.1256 | 4 | 0.00 |
| fitted | right_knee | 1.5716 | 1.4926 | 0.1058 | 0.1758 | 4 | 0.00 |
| fitted | right_ankle | 1.4544 | 1.3825 | 0.0935 | 0.1568 | 4 | 0.00 |
