...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_v9w4k1l1_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_sent_target_velocity_p95_rad_s` | 1.5753 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1865 | 0.2500 |
| `min_base_height_m` | 0.1561 | 0.1200 |
| `min_reward_mean` | 0.4595 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3696 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0504 | NA |
| `max_forward_shortfall_cost_mean` | 0.2738 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1865 | 0.1561 | 0.0296 | 0.3696 | 0.4595 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 90.8000 | 0.0122 | 0.0118 | 27.2000 | 72.8000 | 135 |
| fitted | `right` | 82.0000 | 0.0180 | 0.0165 | 27.2000 | 72.8000 | 135 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0218 | 0.0382 | 0.4242 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0058 | 0.0092 | 0.0120 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4106 | 0.7445 | 1.0549 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0463 | 0.0743 | 0.0862 |
...
| fitted | `reward/imitation` | 0.5890 | 3.3389 | 4.4503 |
| fitted | `reward/tracking_ang_vel` | 0.6692 | 5.0151 | 5.9998 |
| fitted | `reward/tracking_lin_vel` | 1.7442 | 2.4922 | 2.4999 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3696 | 1.2135 | 0.2956 | 0.2738 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3992 | 1.3210 | 0.0880 | 0.1438 | 4 | 0.00 |
| fitted | left_knee | 1.5740 | 1.4866 | 0.1023 | 0.1854 | 4 | 0.00 |
| fitted | left_ankle | 1.3278 | 1.2638 | 0.0866 | 0.1436 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4572 | 1.3538 | 0.0894 | 0.1250 | 4 | 0.00 |
| fitted | right_knee | 1.5753 | 1.4855 | 0.1048 | 0.1763 | 4 | 0.00 |
| fitted | right_ankle | 1.4461 | 1.3630 | 0.0931 | 0.1577 | 4 | 0.00 |
