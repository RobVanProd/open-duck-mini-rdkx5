...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_pdaxpcia_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1935 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5527 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.7792 | 0.2500 |
| `min_base_height_m` | 0.0043 | 0.1200 |
| `min_reward_mean` | 0.4508 | 0.3000 |
| `min_forward_command_tracking_ratio` | 1.5672 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0454 | NA |
| `max_forward_shortfall_cost_mean` | 0.1658 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 180 | fall_or_nan | 0.7792 | 0.0043 | 0.1254 | 1.5672 | 0.4508 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 94.4444 | 0.0584 | 0.0498 | 17.2222 | 82.2222 | 24 |
| fitted | `right` | 87.2222 | 0.0623 | 0.0576 | 17.2222 | 82.2222 | 24 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0200 | 0.0343 | 0.4497 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0055 | 0.0092 | 0.0118 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.5941 | 0.9934 | 1.5672 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0177 | 0.0665 | 0.0825 |
...
| fitted | `reward/imitation` | 0.5409 | 3.2947 | 4.3266 |
| fitted | `reward/tracking_ang_vel` | 0.4462 | 3.5183 | 5.9599 |
| fitted | `reward/tracking_lin_vel` | 1.5760 | 2.4833 | 2.4999 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 1.5672 | 8.7219 | 0.2098 | 0.1658 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 3 | 1 | 0.3333 | 0.1103 | 0.1148 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.2486 | 1.1886 | 0.0876 | 0.1314 | 4 | 0.00 |
| fitted | left_knee | 1.5492 | 1.4588 | 0.1004 | 0.1935 | 4 | 0.00 |
| fitted | left_ankle | 1.2767 | 1.2221 | 0.0843 | 0.1412 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.2729 | 1.2604 | 0.0853 | 0.1188 | 4 | 0.00 |
| fitted | right_knee | 1.5527 | 1.4963 | 0.1037 | 0.1773 | 4 | 0.00 |
| fitted | right_ankle | 1.2827 | 1.2365 | 0.0816 | 0.1430 | 4 | 0.00 |
