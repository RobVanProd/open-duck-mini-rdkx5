...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_voiii9fx_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_sent_target_velocity_p95_rad_s` | 1.6276 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.3731 | 0.2500 |
| `min_base_height_m` | -0.0068 | 0.1200 |
| `min_reward_mean` | 0.4565 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.8843 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0093 | NA |
| `max_forward_shortfall_cost_mean` | 0.1618 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 455 | fall_or_nan | 0.3731 | -0.0068 | 0.0707 | 0.8843 | 0.4565 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 90.5495 | 0.0655 | 0.0617 | 26.3736 | 73.4066 | 73 |
| fitted | `right` | 82.6374 | 0.0604 | 0.0242 | 26.3736 | 73.4066 | 73 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0206 | 0.0358 | 0.4497 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0090 | 0.0122 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4349 | 0.8050 | 1.0058 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0428 | 0.0794 | 0.0926 |
...
| fitted | `reward/imitation` | 0.5433 | 3.3756 | 4.3306 |
| fitted | `reward/tracking_ang_vel` | 0.6355 | 4.7774 | 5.9979 |
| fitted | `reward/tracking_lin_vel` | 1.6704 | 2.4915 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.8843 | 2.0818 | 0.2311 | 0.1618 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 7 | 6 | 0.8571 | 0.1008 | 0.1191 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3280 | 1.2841 | 0.0887 | 0.1387 | 4 | 0.00 |
| fitted | left_knee | 1.5617 | 1.4694 | 0.1014 | 0.1842 | 4 | 0.00 |
| fitted | left_ankle | 1.2715 | 1.2567 | 0.0835 | 0.1410 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4080 | 1.3038 | 0.0876 | 0.1234 | 4 | 0.00 |
| fitted | right_knee | 1.6276 | 1.5709 | 0.1088 | 0.1773 | 4 | 0.00 |
| fitted | right_ankle | 1.3457 | 1.2504 | 0.0866 | 0.1446 | 4 | 0.00 |
