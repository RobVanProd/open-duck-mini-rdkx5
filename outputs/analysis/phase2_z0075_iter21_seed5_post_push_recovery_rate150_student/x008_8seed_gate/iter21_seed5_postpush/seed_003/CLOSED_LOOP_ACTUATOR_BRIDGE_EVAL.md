...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_yozfrnam_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1856 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.6478 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1845 | 0.2500 |
| `min_base_height_m` | 0.0725 | 0.1200 |
| `min_reward_mean` | 0.4533 | 0.3000 |
| `min_forward_command_tracking_ratio` | -0.0747 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0860 | NA |
| `max_forward_shortfall_cost_mean` | 4.8988 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 491 | fall_or_nan | 0.1845 | 0.0725 | -0.0060 | -0.0747 | 0.4533 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 90.6314 | 0.0331 | 0.0111 | 25.4582 | 74.1344 | 77 |
| fitted | `right` | 83.0957 | 0.0321 | 0.0218 | 25.4582 | 74.1344 | 77 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0206 | 0.0369 | 0.4497 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0053 | 0.0088 | 0.0112 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4245 | 0.7832 | 1.0058 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0458 | 0.0835 | 0.4552 |
...
| fitted | `reward/imitation` | 0.6197 | 3.2876 | 4.3266 |
| fitted | `reward/tracking_ang_vel` | 0.5638 | 4.3437 | 5.9999 |
| fitted | `reward/tracking_lin_vel` | 1.5067 | 2.4799 | 2.4999 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -0.0747 | 1.2976 | 0.7468 | 4.8988 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 9 | 7 | 0.7778 | 0.0998 | 0.1212 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3187 | 1.2809 | 0.0882 | 0.1392 | 4 | 0.00 |
| fitted | left_knee | 1.5821 | 1.4699 | 0.1017 | 0.1856 | 4 | 0.00 |
| fitted | left_ankle | 1.3060 | 1.2496 | 0.0839 | 0.1350 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4183 | 1.3338 | 0.0887 | 0.1250 | 4 | 0.00 |
| fitted | right_knee | 1.6478 | 1.5802 | 0.1100 | 0.1817 | 4 | 0.00 |
| fitted | right_ankle | 1.3534 | 1.2654 | 0.0842 | 0.1412 | 4 | 0.00 |
