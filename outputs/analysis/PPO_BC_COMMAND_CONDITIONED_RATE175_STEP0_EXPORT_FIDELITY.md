...
- BC NPZ: `outputs/analysis/command_conditioned_hard_seed_recovery_dagger_seed5_x0_rate175_candidate/candidate_mlp.npz`
- reference ONNX: `policy/candidates/corrected_bridge_cmd_conditioned_rate175_20260627/candidate.onnx`
- manifest: `outputs/analysis/command_conditioned_hard_seed_recovery_dagger_seed5_x0_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/ppo_bc_command_conditioned_rate175_step0_checkpoint`
- exported ONNX: `outputs/analysis/ppo_bc_command_conditioned_rate175_step0.onnx`
