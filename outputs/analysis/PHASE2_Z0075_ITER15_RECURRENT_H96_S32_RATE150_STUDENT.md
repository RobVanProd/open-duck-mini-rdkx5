...
- MAE: `0.013738`
- p95 abs error: `0.041699`
- max abs error: `0.757553`
- target-rate p95: `1.330732` rad/s
- target-rate max: `6.938128` rad/s

## ONNX Verification

- steps checked: `128`
- max action error: `0.00000033`
- max hidden error: `0.00000084`

## Eval Command

```bash
tools/run_candidate_seed_sweep.py \
  --policies recurrent=outputs/analysis/phase2_z0075_iter15_recurrent_h96_s32_rate150_candidate/candidate.onnx \
