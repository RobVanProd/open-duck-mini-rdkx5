...
|---:|---:|---|---|---|---:|---:|---|
| 0.074 | 100 | `HOLD_CANDIDATE_TRACKING` | `True` | `duration_complete` | 0.057917754813679494 | 15 | none |
| 0.074 | 101 | `HOLD_CANDIDATE_TRACKING` | `True` | `duration_complete` | 0.057917754813679494 | 15 | none |
