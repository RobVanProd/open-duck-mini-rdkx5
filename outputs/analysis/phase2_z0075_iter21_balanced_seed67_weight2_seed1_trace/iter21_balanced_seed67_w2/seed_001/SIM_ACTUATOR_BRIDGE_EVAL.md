...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_4lamx_u8_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1918 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.6065 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.3562 | 0.2500 |
| `min_base_height_m` | 0.0153 | 0.1200 |
| `min_reward_mean` | 0.4532 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.7801 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0176 | NA |
| `max_forward_shortfall_cost_mean` | 0.1909 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 454 | fall_or_nan | 0.3562 | 0.0153 | 0.0624 | 0.7801 | 0.4532 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 89.2070 | 0.0618 | 0.0481 | 25.9912 | 73.7885 | 91 |
| fitted | `right` | 84.3612 | 0.0601 | 0.0387 | 25.9912 | 73.7885 | 91 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0217 | 0.0353 | 0.4272 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0057 | 0.0089 | 0.0114 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4333 | 0.8184 | 1.0700 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0455 | 0.0922 | 0.1002 |
...
| fitted | `reward/imitation` | 0.5861 | 3.4407 | 4.3583 |
| fitted | `reward/tracking_ang_vel` | 0.4461 | 4.0929 | 5.9978 |
| fitted | `reward/tracking_lin_vel` | 1.6547 | 2.4853 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.7801 | 1.8323 | 0.2633 | 0.1909 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 8 | 7 | 0.8750 | 0.0997 | 0.1199 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3260 | 1.2594 | 0.0864 | 0.1383 | 4 | 0.00 |
| fitted | left_knee | 1.6038 | 1.5082 | 0.1042 | 0.1918 | 4 | 0.00 |
| fitted | left_ankle | 1.4128 | 1.3069 | 0.0889 | 0.1459 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4108 | 1.2860 | 0.0865 | 0.1258 | 4 | 0.00 |
| fitted | right_knee | 1.6065 | 1.5389 | 0.1077 | 0.1698 | 4 | 0.00 |
| fitted | right_ankle | 1.3742 | 1.3126 | 0.0896 | 0.1479 | 4 | 0.00 |
