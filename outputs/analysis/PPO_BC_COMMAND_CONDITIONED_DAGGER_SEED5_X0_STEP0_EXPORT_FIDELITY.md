...
- reference ONNX: `outputs/analysis/command_conditioned_hard_seed_recovery_dagger_seed5_x0_candidate/candidate.onnx`
...
- exported ONNX: `outputs/analysis/ppo_bc_command_conditioned_dagger_seed5_x0_step0.onnx`
