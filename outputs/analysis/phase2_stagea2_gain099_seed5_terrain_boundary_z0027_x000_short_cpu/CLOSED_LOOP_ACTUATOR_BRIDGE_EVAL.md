...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0027, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_0_60xtz7_hfield_z0.0027.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1915 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.1327 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0771 | 0.2500 |
| `min_base_height_m` | 0.0604 | 0.1200 |
| `min_reward_mean` | 0.4100 | 0.3000 |
| `min_forward_command_tracking_ratio` | NA | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.2439 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 62 | fall_or_nan | -0.0771 | 0.0604 | -0.2439 | NA | 0.4100 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 87.0968 | 0.0283 | 0.0276 | 14.5161 | 82.2581 | 10 |
| fitted | `right` | 91.9355 | 0.0432 | 0.0404 | 14.5161 | 82.2581 | 10 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0142 | 0.0232 | 0.4752 |
| fitted | `cost/stand_still` | 1.3427 | 4.8112 | 6.2840 |
| fitted | `cost/torques` | 0.0051 | 0.0241 | 0.0580 |
...
| fitted | `reward/tracking_ang_vel` | 0.9101 | 5.7191 | 5.9983 |
| fitted | `reward/tracking_lin_vel` | 0.9539 | 2.4917 | 2.4992 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.0535 | 1.0809 | 0.0782 | 0.1021 | 4 | 0.00 |
| fitted | left_knee | 1.0954 | 1.0235 | 0.0669 | 0.1793 | 4 | 0.00 |
| fitted | left_ankle | 1.0431 | 1.2044 | 0.0990 | 0.1915 | 4 | 0.00 |
| fitted | right_hip_pitch | 0.7992 | 0.9708 | 0.0716 | 0.1362 | 4 | 0.00 |
| fitted | right_knee | 1.1327 | 1.0388 | 0.0667 | 0.1413 | 4 | 0.00 |
| fitted | right_ankle | 0.5668 | 0.7164 | 0.0580 | 0.1176 | 4 | 0.00 |
