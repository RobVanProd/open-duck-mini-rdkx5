...
- BC NPZ: `outputs/analysis/phase2_rate165_ppo_loc_warmstart_candidate/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/phase2_rate165_ppo_loc_warmstart_candidate/candidate.onnx`
- manifest: `outputs/analysis/phase2_rate165_ppo_loc_warmstart_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/phase2_rate165_ppo_loc_warmstart_step0_checkpoint`
- exported ONNX: `outputs/analysis/phase2_rate165_ppo_loc_warmstart_step0.onnx`
