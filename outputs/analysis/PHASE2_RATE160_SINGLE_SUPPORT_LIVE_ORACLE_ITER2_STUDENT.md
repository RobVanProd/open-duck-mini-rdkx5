...
- NPZ: `outputs/analysis/phase2_rate160_single_support_live_oracle_iter2_student/candidate_mlp.npz`
- ONNX: `outputs/analysis/phase2_rate160_single_support_live_oracle_iter2_student/candidate.onnx`

## Fit Metrics

- MAE: `0.007431`
- p95 abs error: `0.021361`
- max abs error: `0.310001`
- target-rate p95: `1.431301` rad/s
- target-rate max: `1.878983` rad/s
