...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| left_hip_pitch | 3 | 60.3 | 0.020 | 2.50 | 0.0252 | 0.0149 | 0.0132 | 0.0252 | 0.1736 | 0.3493 | 0.2760 | 0.790 | 5.2170 | 2.4047 | 4 | GOOD | tau_s hit lower grid bound |
| left_knee | 3 | 60.3 | 0.020 | 3.25 | 0.0329 | 0.0169 | 0.0151 | 0.0329 | 0.1793 | 0.3430 | 0.3230 | 0.942 | 3.7814 | 2.9371 | 3 | GOOD | tau_s hit lower grid bound |
| left_ankle | 3 | 60.3 | 0.020 | 3.25 | 0.0192 | 0.0107 | 0.0098 | 0.0192 | 0.1325 | 0.2444 | 0.2030 | 0.831 | 3.7399 | 2.1407 | 3 | GOOD | tau_s hit lower grid bound |
| right_hip_pitch | 3 | 60.3 | 0.020 | 3.00 | 0.0284 | 0.0155 | 0.0139 | 0.0284 | 0.1661 | 0.2492 | 0.2700 | 1.083 | 3.1013 | 2.6398 | 3 | GOOD | tau_s hit lower grid bound |
| right_knee | 3 | 60.3 | 0.020 | 2.75 | 0.0340 | 0.0197 | 0.0177 | 0.0340 | 0.2062 | 0.3608 | 0.3210 | 0.890 | 4.8109 | 3.1864 | 3 | GOOD | tau_s hit lower grid bound |
| right_ankle | 3 | 60.3 | 0.020 | 2.25 | 0.0273 | 0.0144 | 0.0127 | 0.0273 | 0.1428 | 0.2796 | 0.2470 | 0.883 | 3.5230 | 2.1408 | 3 | GOOD | tau_s hit lower grid bound |

## Model Family Comparison

| joint | delay_only_rmse | first_order_rmse | velocity_only_rmse | combined_rmse | support |
|---|---:|---:|---:|---:|---|
| left_hip_pitch | 0.0286 | 0.0411 | 0.0510 | 0.0149 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| left_knee | 0.0191 | 0.0483 | 0.0579 | 0.0169 | delay improves over lag-only; lag/delay improves over velocity-only |
| left_ankle | 0.0184 | 0.0308 | 0.0366 | 0.0107 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| right_hip_pitch | 0.0229 | 0.0415 | 0.0406 | 0.0155 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| right_knee | 0.0302 | 0.0617 | 0.0705 | 0.0197 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
| right_ankle | 0.0241 | 0.0370 | 0.0445 | 0.0144 | lag/velocity improves over delay-only; delay improves over lag-only; lag/delay improves over velocity-only |
...
|---|---:|---:|---:|---:|
| left_hip_pitch | 0.0105 | 0.1241 | 0.0022 | 0.0046 |
