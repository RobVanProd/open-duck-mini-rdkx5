...
- policy_path: `/home/lsd/robots/open-duck-mini-rdkx5/outputs/analysis/source_vx_selector_trace_dagger2_mlp128_candidate/candidate.onnx`
- policy_sha256: `a4e8575afc7a88fec336207fa6622e68387212c90596fbe6c0d038be4d5f4460`
- observation: `[1, 101]`
- action: `[1, 14]`
...
|---|---:|---|
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/joints_properties.xml` | 0 | `[]` |
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/open_duck_mini_v2.xml` | 14 | `[]` |
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/open_duck_mini_v2_backlash.xml` | 14 | `[]` |
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/scene_flat_terrain.xml` | 14 | `[14]` |
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/scene_flat_terrain_backlash.xml` | 14 | `[14]` |
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml` | 14 | `[14]` |
| `/tmp/open_duck_playground_origin_main/playground/open_duck_mini_v2/xmls/sensors.xml` | 0 | `[]` |
