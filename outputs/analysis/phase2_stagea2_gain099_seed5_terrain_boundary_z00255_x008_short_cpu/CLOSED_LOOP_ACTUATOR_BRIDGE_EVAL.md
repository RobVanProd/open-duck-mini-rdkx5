...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.00255, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_ren86qb0_hfield_z0.00255.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1894 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.9958 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 1.3401 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0710 | 0.2500 |
| `min_base_height_m` | 0.0593 | 0.1200 |
| `min_reward_mean` | 0.4098 | 0.3000 |
| `min_forward_command_tracking_ratio` | -3.2722 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.3418 | NA |
| `max_forward_shortfall_cost_mean` | 41.5077 | NA |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 89.6552 | 0.0304 | 0.0300 | 17.2414 | 79.3103 | 9 |
| fitted | `right` | 86.2069 | 0.0449 | 0.0364 | 17.2414 | 79.3103 | 9 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0255 | 0.0490 | 0.2230 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0062 | 0.0220 | 0.0570 |
...
| fitted | `diagnostic/command_progress_ratio` | -0.0592 | 1.7687 | 1.9203 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 1.3536 | 9.7643 | 14.9937 |
...
| fitted | `reward/imitation` | -0.2179 | 2.9154 | 3.3091 |
| fitted | `reward/tracking_ang_vel` | 0.3009 | 1.1789 | 5.8917 |
| fitted | `reward/tracking_lin_vel` | 0.4406 | 1.9042 | 2.4866 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | -3.2722 | 2.1613 | 3.9571 | 41.5077 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.8621 | 1.5366 | 0.0918 | 0.1042 | 3 | 0.00 |
| fitted | left_knee | 1.9958 | 1.7067 | 0.1045 | 0.1894 | 3 | 0.00 |
| fitted | left_ankle | 0.9908 | 0.9305 | 0.0710 | 0.1662 | 4 | 0.00 |
| fitted | right_hip_pitch | 0.9651 | 0.8153 | 0.0482 | 0.1743 | 3 | 0.00 |
| fitted | right_knee | 1.7037 | 1.3672 | 0.0795 | 0.1694 | 3 | 0.00 |
| fitted | right_ankle | 1.4746 | 1.4799 | 0.0703 | 0.1356 | 3 | 0.00 |
