...
| `max_abs_forward_velocity_error_m_s` | 0.0002 | NA |

### Mode Summary

| mode | samples | termination | body_pitch_p95 | base_height_min | mean_vx | track_ratio | reward_mean |
|---|---:|---|---:|---:|---:|---:|---:|
| vanilla | 750 | duration_complete | 0.0136 | 0.1538 | 0.0001 | NA | 0.5552 |
| fitted | 750 | duration_complete | 0.0135 | 0.1536 | -0.0000 | NA | 0.5584 |
| stress | 750 | duration_complete | 0.0090 | 0.1536 | -0.0002 | NA | 0.5638 |
