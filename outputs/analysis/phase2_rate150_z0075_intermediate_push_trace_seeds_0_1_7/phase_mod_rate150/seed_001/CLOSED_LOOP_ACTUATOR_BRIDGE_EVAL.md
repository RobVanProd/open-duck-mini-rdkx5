...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_x3deea88_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1909 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5960 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1878 | 0.2500 |
| `min_base_height_m` | 0.1533 | 0.1200 |
| `min_reward_mean` | 0.4583 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3864 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0491 | NA |
| `max_forward_shortfall_cost_mean` | 0.2215 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1878 | 0.1533 | 0.0309 | 0.3864 | 0.4583 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 92.5333 | 0.0156 | 0.0148 | 22.8000 | 77.2000 | 104 |
| fitted | `right` | 84.6667 | 0.0214 | 0.0177 | 22.8000 | 77.2000 | 104 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0219 | 0.0376 | 0.5087 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0056 | 0.0091 | 0.0112 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3912 | 0.6929 | 0.9494 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0510 | 0.0676 | 0.0805 |
...
| fitted | `reward/imitation` | 0.6308 | 3.4189 | 4.3919 |
| fitted | `reward/tracking_ang_vel` | 0.5871 | 4.9128 | 5.9998 |
| fitted | `reward/tracking_lin_vel` | 1.7259 | 2.4896 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3864 | 1.2868 | 0.2832 | 0.2215 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 13 | 13 | 1.0000 | 0.0988 | 0.1220 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3842 | 1.2814 | 0.0883 | 0.1410 | 4 | 0.00 |
| fitted | left_knee | 1.5960 | 1.4961 | 0.1036 | 0.1909 | 4 | 0.00 |
| fitted | left_ankle | 1.3851 | 1.3250 | 0.0901 | 0.1504 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3739 | 1.2733 | 0.0849 | 0.1225 | 4 | 0.00 |
| fitted | right_knee | 1.5409 | 1.4797 | 0.1038 | 0.1771 | 4 | 0.00 |
| fitted | right_ankle | 1.4449 | 1.3395 | 0.0903 | 0.1539 | 4 | 0.00 |
