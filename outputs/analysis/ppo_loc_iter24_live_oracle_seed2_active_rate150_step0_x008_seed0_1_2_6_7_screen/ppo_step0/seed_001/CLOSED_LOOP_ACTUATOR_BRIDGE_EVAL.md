...
policy: `/home/lsd/robots/open-duck-mini-rdkx5/outputs/analysis/ppo_loc_iter24_live_oracle_seed2_active_rate150_step0.onnx`
...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_sam2ltje_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1817 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5284 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1928 | 0.2500 |
| `min_base_height_m` | 0.1583 | 0.1200 |
| `min_reward_mean` | 0.4592 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.3428 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0526 | NA |
| `max_forward_shortfall_cost_mean` | 0.1906 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.1928 | 0.1583 | 0.0274 | 0.3428 | 0.4592 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 94.0000 | 0.0167 | 0.0125 | 25.4667 | 74.5333 | 130 |
| fitted | `right` | 80.5333 | 0.0251 | 0.0169 | 25.4667 | 74.5333 | 130 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0213 | 0.0389 | 0.1525 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0088 | 0.0104 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.4359 | 0.6830 | 1.0433 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0354 | 0.0625 | 0.0676 |
...
| fitted | `reward/imitation` | 0.6560 | 3.2981 | 4.2459 |
| fitted | `reward/tracking_ang_vel` | 0.6200 | 5.1543 | 5.9992 |
| fitted | `reward/tracking_lin_vel` | 1.7101 | 2.4850 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.3428 | 1.1680 | 0.2865 | 0.1906 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.4281 | 1.3468 | 0.0901 | 0.1417 | 4 | 0.00 |
| fitted | left_knee | 1.5106 | 1.4464 | 0.0997 | 0.1817 | 4 | 0.00 |
| fitted | left_ankle | 1.3991 | 1.3383 | 0.0902 | 0.1464 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4205 | 1.3129 | 0.0860 | 0.1226 | 4 | 0.00 |
| fitted | right_knee | 1.5284 | 1.4748 | 0.1037 | 0.1700 | 4 | 0.00 |
| fitted | right_ankle | 1.4138 | 1.3356 | 0.0901 | 0.1500 | 4 | 0.00 |
