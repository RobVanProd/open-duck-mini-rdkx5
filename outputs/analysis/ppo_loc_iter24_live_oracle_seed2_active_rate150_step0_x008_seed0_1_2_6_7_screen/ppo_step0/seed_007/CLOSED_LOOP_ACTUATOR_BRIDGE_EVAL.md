...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_ag977cu6_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1783 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5336 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.3193 | 0.2500 |
| `min_base_height_m` | 0.0033 | 0.1200 |
| `min_reward_mean` | 0.4583 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.6774 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0258 | NA |
| `max_forward_shortfall_cost_mean` | 0.1946 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 577 | fall_or_nan | 0.3193 | 0.0033 | 0.0542 | 0.6774 | 0.4583 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 93.0676 | 0.0655 | 0.0616 | 23.0503 | 76.2565 | 108 |
| fitted | `right` | 82.4957 | 0.0600 | 0.0488 | 23.0503 | 76.2565 | 108 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0215 | 0.0384 | 0.1525 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0053 | 0.0087 | 0.0113 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3672 | 0.7742 | 1.0433 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0721 | 0.1115 | 0.1161 |
...
| fitted | `reward/imitation` | 0.6307 | 3.3276 | 4.2459 |
| fitted | `reward/tracking_ang_vel` | 0.6702 | 4.9205 | 5.9985 |
| fitted | `reward/tracking_lin_vel` | 1.6427 | 2.4774 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.6774 | 1.7683 | 0.2815 | 0.1946 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 8 | 7 | 0.8750 | 0.0920 | 0.1099 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.3933 | 1.3116 | 0.0898 | 0.1437 | 4 | 0.00 |
| fitted | left_knee | 1.5160 | 1.4451 | 0.1002 | 0.1783 | 4 | 0.00 |
| fitted | left_ankle | 1.4039 | 1.3256 | 0.0897 | 0.1473 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.3888 | 1.3122 | 0.0851 | 0.1220 | 4 | 0.00 |
| fitted | right_knee | 1.5336 | 1.4713 | 0.1034 | 0.1664 | 4 | 0.00 |
| fitted | right_ankle | 1.4234 | 1.3351 | 0.0881 | 0.1514 | 4 | 0.00 |
