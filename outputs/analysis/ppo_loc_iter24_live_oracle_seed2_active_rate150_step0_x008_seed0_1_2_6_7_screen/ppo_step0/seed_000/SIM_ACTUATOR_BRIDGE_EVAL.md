...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0075, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_22v03cqo_hfield_z0.0075.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.1782 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 1.5193 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.1650 | 0.2500 |
| `min_base_height_m` | 0.0788 | 0.1200 |
...
| `max_forward_shortfall_cost_mean` | 3.4975 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 638 | fall_or_nan | 0.1650 | 0.0788 | 0.0015 | 0.0190 | 0.4562 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 92.1630 | 0.0366 | 0.0135 | 24.4514 | 75.3918 | 92 |
| fitted | `right` | 83.0721 | 0.0354 | 0.0155 | 24.4514 | 75.3918 | 92 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0211 | 0.0370 | 0.1525 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0054 | 0.0087 | 0.0110 |
...
| fitted | `diagnostic/command_progress_ratio` | 0.3976 | 0.7350 | 1.0433 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.0537 | 0.0925 | 0.3375 |
...
| fitted | `reward/imitation` | 0.5502 | 3.3143 | 4.2459 |
| fitted | `reward/tracking_ang_vel` | 0.6832 | 5.2173 | 5.9995 |
| fitted | `reward/tracking_lin_vel` | 1.6022 | 2.4897 | 2.5000 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.0190 | 1.1725 | 0.6152 | 3.4975 |

### Push Recovery

| mode | events | recovered | success_rate | push_mag_mean | push_mag_max |
|---|---:|---:|---:|---:|---:|
| fitted | 10 | 9 | 0.9000 | 0.1090 | 0.1215 |

### Pitch-Chain Summary

| mode | joint | sent_vel_p95 | applied_vel_p95 | bridge_tracking_p95 | joint_tracking_p95 | lag_ticks | action_sat_pct |
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 1.4079 | 1.3440 | 0.0898 | 0.1401 | 4 | 0.00 |
| fitted | left_knee | 1.5193 | 1.4387 | 0.1006 | 0.1782 | 4 | 0.00 |
| fitted | left_ankle | 1.4086 | 1.3429 | 0.0918 | 0.1434 | 4 | 0.00 |
| fitted | right_hip_pitch | 1.4074 | 1.2698 | 0.0877 | 0.1243 | 4 | 0.00 |
| fitted | right_knee | 1.5190 | 1.4603 | 0.1030 | 0.1702 | 4 | 0.00 |
| fitted | right_ankle | 1.4045 | 1.3354 | 0.0900 | 0.1534 | 4 | 0.00 |
