...
|---|---:|---|---:|---|---:|---|---:|---:|---:|
| `final` | 0.000 | `HOLD_CANDIDATE_ACTION_SATURATION` | 50 | `duration_complete` | 0.0000 | `BELOW_MEASURED_ENVELOPE` | 0.3686 | NA | -0.1203 |
| `final` | 0.080 | `HOLD_CANDIDATE_LOW_FORWARD_PROGRESS` | 50 | `duration_complete` | 1.2304 | `BELOW_MEASURED_ENVELOPE` | 0.2081 | 0.1557 | 0.0125 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| `final` | `HOLD_REJECT_CANDIDATE_CHECKPOINT` | 0/2 | 2/2 | 1.2304 | 0.3686 | 100.0000 | 0.1557 |

### Hold Reasons

- `final`: command 0: HOLD_CANDIDATE_ACTION_SATURATION; command 0.08: HOLD_CANDIDATE_LOW_FORWARD_PROGRESS; command 0.08: track ratio 0.1557 < 0.2500; command 0.08: mean vx 0.0125 < 0.0200
