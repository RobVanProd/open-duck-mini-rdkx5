...
- BC NPZ: `outputs/analysis/ppo_loc_swish_command_conditioned_candidate/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/ppo_loc_swish_command_conditioned_candidate/candidate.onnx`
- manifest: `outputs/analysis/ppo_swish_command_conditioned_manifest.json`

## Outputs

- checkpoint: `outputs/analysis/ppo_bc_swish_command_conditioned_step0_checkpoint`
- exported ONNX: `outputs/analysis/ppo_bc_swish_command_conditioned_step0.onnx`
