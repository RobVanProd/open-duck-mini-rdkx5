...
generated_at: `2026-06-29T17:30:57Z`
...
| `stage_z005_support` | `HOLD_STAGE` | `z005_x008_nopush` | `z005_x000_nopush` | `stage_z005_gentle_push` |
...
| `z005_x000_nopush` | `MISSING_GATE_ARTIFACT` | NA | NA | NA | 0.000 | 0.005 | `False` | NA | NA | NA | NA | NA | artifact missing |
