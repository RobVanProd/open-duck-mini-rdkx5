...
- manifest: `outputs/analysis/phase2_parent_pair_lateral_seed7_weighted_manifest.json`
- samples: `3750`
...
- NPZ: `outputs/analysis/phase2_parent_pair_lateral_seed7_weighted_student/candidate_mlp.npz`
- ONNX: `outputs/analysis/phase2_parent_pair_lateral_seed7_weighted_student/candidate.onnx`

## Fit Metrics

- MAE: `0.002721`
- p95 abs error: `0.006911`
- max abs error: `0.056401`
- target-rate p95: `1.422418` rad/s
- target-rate max: `1.808801` rad/s
