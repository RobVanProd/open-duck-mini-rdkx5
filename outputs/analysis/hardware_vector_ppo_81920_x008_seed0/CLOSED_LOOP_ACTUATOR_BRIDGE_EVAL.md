...
policy: `/home/lsd/robots/open-duck-mini-rdkx5/outputs/analysis/colab_hardware_vector_results/extracted/2026_07_12_151014_81920.onnx`
...
terrain_override: `{'enabled': True, 'hfield_z_scale': 0.0026, 'source_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/scene_rough_terrain_backlash.xml', 'temp_xml': '/home/lsd/robots/Open_Duck_Playground/playground/open_duck_mini_v2/xmls/.codex_eval_0x0ap78v_hfield_z0.0026.xml'}`
worker_returncode: `0`
...
| `max_pitch_tracking_p95_rad` | 0.0412 | 0.2000 |
| `max_sent_target_velocity_p95_rad_s` | 0.1405 | NA |
| `max_sent_target_velocity_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_sent_target_velocity_max_limit_excess_rad_s` | 0.0000 | 0.0000 |
| `max_abs_body_pitch_p95_rad` | 0.0155 | 0.2500 |
| `min_base_height_m` | 0.1524 | 0.1200 |
| `min_reward_mean` | 0.5025 | 0.3000 |
| `min_forward_command_tracking_ratio` | 0.0021 | 0.2500 |
| `max_abs_forward_velocity_error_m_s` | 0.0798 | NA |
| `max_forward_shortfall_cost_mean` | 0.2505 | NA |
...
|---|---:|---|---:|---:|---:|---:|---:|
| fitted | 750 | duration_complete | 0.0155 | 0.1524 | 0.0002 | 0.0021 | 0.5025 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | `left` | 100.0000 | NA | NA | 0.0000 | 100.0000 | 0 |
| fitted | `right` | 100.0000 | NA | NA | 0.0000 | 100.0000 | 0 |

### Reward-Term Summary

| mode | term | mean | p95 | max |
|---|---|---:|---:|---:|
| fitted | `cost/action_rate` | 0.0003 | 0.0003 | 0.0711 |
| fitted | `cost/stand_still` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `cost/torques` | 0.0009 | 0.0011 | 0.0019 |
...
| fitted | `diagnostic/command_progress_ratio` | -0.0007 | 0.0059 | 0.0369 |
| fitted | `diagnostic/command_progress_shortfall_cost` | 0.3342 | 0.3582 | 0.3842 |
...
| fitted | `diagnostic/target_rate_limit_cost` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `diagnostic/target_velocity_cost` | 0.0000 | 0.0000 | 0.0000 |
| fitted | `reward/alive` | 20.0000 | 20.0000 | 20.0000 |
| fitted | `reward/imitation` | 0.6684 | 2.7432 | 3.1477 |
| fitted | `reward/tracking_ang_vel` | 3.1370 | 5.9821 | 6.0000 |
| fitted | `reward/tracking_lin_vel` | 1.3226 | 1.4306 | 1.6048 |
...
|---|---|---:|---:|---:|---:|---:|
| fitted | `PASS_DIAGNOSTIC` | 0.5000 | 0.0021 | 0.0661 | 0.4979 | 0.2505 |
...
|---|---|---:|---:|---:|---:|---:|---:|
| fitted | left_hip_pitch | 0.1135 | 0.1134 | 0.0065 | 0.0207 | 3 | 0.00 |
| fitted | left_knee | 0.0618 | 0.0614 | 0.0037 | 0.0377 | 3 | 0.00 |
| fitted | left_ankle | 0.1382 | 0.1357 | 0.0082 | 0.0169 | 3 | 0.00 |
| fitted | right_hip_pitch | 0.0422 | 0.0412 | 0.0024 | 0.0085 | 3 | 0.00 |
| fitted | right_knee | 0.1358 | 0.1271 | 0.0078 | 0.0412 | 3 | 0.00 |
| fitted | right_ankle | 0.1405 | 0.1409 | 0.0082 | 0.0138 | 3 | 0.00 |
