...
```bash
OPERATOR_ONLY_PLACEHOLDER --fixed-command-x 0.080 --duration 15.0 --jsonl outputs/first_evidence/<timestamp>/instrumented_lowcmd_hw_eval.jsonl
```
