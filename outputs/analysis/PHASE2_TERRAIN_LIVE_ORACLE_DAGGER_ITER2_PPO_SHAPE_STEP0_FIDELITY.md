...
- BC NPZ: `outputs/analysis/phase2_terrain_live_oracle_dagger_iter2_ppo_shape_bc_student/candidate_mlp.npz`
- reference ONNX: `outputs/analysis/phase2_terrain_live_oracle_dagger_iter2_ppo_shape_bc_student/candidate.onnx`
...
- exported ONNX: `outputs/analysis/phase2_terrain_live_oracle_dagger_iter2_ppo_shape_step0.onnx`
