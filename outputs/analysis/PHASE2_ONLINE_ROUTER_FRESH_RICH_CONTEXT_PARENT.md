...
- manifest: `outputs/analysis/phase2_online_router_fresh_selected_manifest.json`
- samples: `3750`
...
- NPZ: `outputs/analysis/phase2_online_router_fresh_rich_context_parent/candidate_mlp.npz`
- ONNX: `outputs/analysis/phase2_online_router_fresh_rich_context_parent/candidate.onnx`

## Fit Metrics

- MAE: `0.002331`
- p95 abs error: `0.005937`
- max abs error: `0.037892`
- target-rate p95: `1.431583` rad/s
- target-rate max: `1.869651` rad/s
