...
generated_at: `2026-07-06T09:47:19Z`
...
`open-duck-t4-stagea` Colab session twice with `--execution-mode detached`.

Both allocation attempts returned `HOLD_SERVICE_UNAVAILABLE` from `colab new`.
