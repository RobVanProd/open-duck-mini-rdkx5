...
|---:|---:|---|---|---|---:|---:|---|
| 0.074 | 100 | `HOLD_CANDIDATE_TRACKING` | `True` | `duration_complete` | 0.06910228196531534 | 5 | none |
| 0.074 | 101 | `HOLD_CANDIDATE_TRACKING` | `True` | `duration_complete` | 0.06910228196531534 | 5 | none |
