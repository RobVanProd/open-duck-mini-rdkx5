...
| `foot_placement_mpc_teacher_stance_relative_lateral_probe_score_100` | `HOLD_NO_SEED_ROBUST_TARGETS` | 100 | 0 | 3 | 0 |
| `foot_placement_mpc_teacher_stance_relative_lateral_probe_score_150` | `HOLD_NO_SEED_ROBUST_TARGETS` | 150 | 0 | 3 | 0 |
| `foot_placement_mpc_teacher_stance_relative_velocity_cap_probe_score_100` | `HOLD_NO_SEED_ROBUST_TARGETS` | 100 | 0 | 3 | 0 |
| `foot_placement_mpc_teacher_stance_relative_velocity_cap_probe_score_150` | `HOLD_NO_SEED_ROBUST_TARGETS` | 150 | 0 | 3 | 0 |
