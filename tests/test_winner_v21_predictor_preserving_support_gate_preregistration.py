...
PREREG = ROOT / "outputs/analysis/winner_v21_predictor_preserving_support_gate_preregistration.json"
...
def test_gate_preregistration_is_exact_when_present() -> None:
    ...
    assert value["status"] == "PREREGISTERED_WINNER_V21_PREDICTOR_PRESERVING_SUPPORT_GATE"
...
def test_workflow_is_dormant_until_preregistration_exists() -> None:
    ...
    assert "winner_v21_predictor_preserving_support_gate_preregistration.json" in trigger
