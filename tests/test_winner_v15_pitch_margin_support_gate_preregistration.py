...
PREREG = ROOT / "outputs/analysis/winner_v15_pitch_margin_support_gate_preregistration.json"
...
def test_gate_preregistration_is_exact_when_present() -> None:
    ...
    assert value["status"] == "PREREGISTERED_WINNER_V15_PITCH_MARGIN_SUPPORT_GATE"
...
def test_workflow_is_dormant_until_preregistration_exists() -> None:
    ...
    assert "winner_v15_pitch_margin_support_gate_preregistration.json" in trigger
    assert "run_winner_v15_pitch_margin_support_gate.py" in source
